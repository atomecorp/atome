...
Opal.modules["atome/version"] = function(Opal) {/* Generated by Opal 1.5.1 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    return $const_set($nesting[0], 'VERSION', "0.4.5.4")
...
Opal.modules["atome/kernel/generators/genesis"] = function(Opal) {/* Generated by Opal 1.5.1 */
  ...
  Opal.add_stubs('validation,run_optional_methods_helper,to_sym,broadcaster,history,instance_variable_get,is_a?,puts,instance_exec,to_proc,set_new_particle,get_new_particle,new,atomes_add,instance_variable_set,each,send,create_new_atomes,[],current_user,app_identity,length,atomes,add_essential_properties,sanitizer,set_new_atome,get_new_atome,additional,include,[]=,define_method,renderer_list,define_singleton_method,atome_creator_option,additional_atomes,generate_renderers_methods,atome_list,new_atome,optional_atome_methods,additional_atome_methods,render_engine,optional_particle_methods,particle_list,new_particle,additional_particle_methods');
    ...
    $def(self, '$new_particle', function $$new_particle(particle, params, proc) {
      ...
      if ($truthy(params)) {
        ...
        if ($truthy(methodproc['$is_a?']($$('Proc')))) {
          ...
          self.$puts("msg from new_particle : " + (particle) + " " + (params));
  ...
  return (function($base, $parent_nesting) {
    ...
    $defs(self, '$atome_creator', function $$atome_creator(method_name) {
      ...
      $send($$('Atome'), 'define_method', [method_name], function $$14(params){var user_proc = $$14.$$p || nil, self = $$14.$$s == null ? this : $$14.$$s;
        ...
        if (params == null) params = nil;;
        self.$puts(" from self.atome_creator\n" + (params));
...
;
  ...
  $send($$('Genesis'), 'atome_creator_option', ["code_pre_render_proc"], function $$51(params){var self = $$51.$$s == null ? this : $$51.$$s, str = nil;
    ...
    $def(self, '$get_binding', function $$get_binding() {
      ...
      return Opal.Binding.$new(  function($code) {    return eval($code);  },  [],  self,  ['atome/kernel/generators/generator.rb', 444])
    }, 0);
    str = params['$[]']("value");
    self.$eval(str, self.$get_binding(), "atome/kernel/generators/generator.rb", 447);
    return params['$[]']("value");}, {$$arity: 1, $$s: self});
...
Opal.modules["atome/kernel/generators/shapes"] = function(Opal) {/* Generated by Opal 1.5.1 */
  ...
  Opal.add_stubs('[],default_params,length,atomes,instance_of?,id,merge,new,shape,box,grab,circle,text,video');
  ...
  return $def(self, '$video', function $$video(params) {
    ...
    if (params == null) params = $hash2([], {});;
    return $$('Utilities').$grab("view").$video(params);
  }, -1);
};
