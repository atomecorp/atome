Opal.queue(function(Opal) {/* Generated by Opal 1.5.1 */
  ...
  Opal.add_stubs('box,height,left,smooth,touch,color,length,atomes,top,rotate,alert,puts,particle_creator,generate_headless_renderer,class,is_a?,instance_exec,to_proc,generate_html_renderer,==,remove_class,add_class,new,drag,shape,x,y,circle');
  ...
  $send(a.$shape(), 'drag', [true], function $$5(e){var self = $$5.$$s == null ? this : $$5.$$s;
    ...
    if (e == null) e = nil;;
    return self.$puts("drag_is_ok : " + (e.$x()) + "," + (e.$y()));}, {$$arity: 1, $$s: self});
