Opal.queue(function(Opal) {/* Generated by Opal 1.5.1 */
  ...
  Opal.add_stubs('box,height,left,smooth,touch,color,length,atomes,top,rotate,alert,new,drag,shape,puts,==,circle,atome_creator,particle_creator,generate_html_renderer,[]=,+,to_s,now,id,is_a?,instance_exec,to_proc,append_to,DOM,atome,image,[],text=,style,div,video');
...
;
  ...
  image = $$('Atome').$new($hash2(["image"], {"image": $hash2(["render", "id", "type", "parent", "path", "left", "top", "width", "height", "color"], {"render": ["html"], "id": "image_12", "type": "image", "parent": "view", "path": "./medias/images/boat.png", "left": 99, "top": 120, "width": 99, "height": 199, "color": $hash2(["render", "id", "type", "red", "green", "blue", "alpha"], {"render": ["html"], "id": "c315", "type": "color", "red": 0, "green": 1, "blue": 1, "alpha": 0.6})})}));
