//
//  webviewauv3AudioUnit.m
//  webviewauv3
//
//  Created by jeezs on 26/04/2022.
//

#import "webviewauv3AudioUnit.h"
...
@interface webviewauv3AudioUnit ()
...
@implementation webviewauv3AudioUnit
...
- (instancetype)initWithComponentDescription:(AudioComponentDescription)componentDescription options:(AudioComponentInstantiationOptions)options error:(NSError **)outError {
	...
	_kernelAdapter = [[webviewauv3DSPKernelAdapter alloc] init];
...
- (void)setupParameterCallbacks {
	...
	__block webviewauv3DSPKernelAdapter * kernelAdapter = _kernelAdapter;
