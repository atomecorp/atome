...
Opal.modules["atome/version"] = function(Opal) {/* Generated by Opal 1.5.1 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    return $const_set($nesting[0], 'VERSION', "0.441")
...
Opal.modules["atome/kernel/generators/shapes"] = function(Opal) {/* Generated by Opal 1.5.1 */
  ...
  Opal.add_stubs('[],length,atomes,instance_of?,id,merge,new,box,grab,circle');
  ...
  (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$box', function $$box(params) {
      var self = this, generated_id = nil, $ret_or_1 = nil, generated_render = nil, generated_parent = nil, temp_default = nil;
      ...
      if (!$truthy(params['$[]']("render")['$instance_of?']($$('Hash')))) {
        generated_render = ($truthy(($ret_or_1 = params['$[]']("render"))) ? ($ret_or_1) : ("html"))
      };
