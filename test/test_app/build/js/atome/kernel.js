...
Opal.modules["atome/kernel/generators/generator"] = function(Opal) {/* Generated by Opal 1.5.1 */
  ...
  Opal.add_stubs('atome_creator,atome_creator_option,instance_of?,==,downcase,each_with_index,split,gsub,[]=,[],keys,/,to_i,css_rgb,merge,id,particle_creator,generate_html_renderer,send,is_a?,instance_exec,to_proc,append_to,DOM,atome,div,<<,head,green,blue,alpha,inner_html=,*,red,each,add_class,style,method_name,===,to_s,join,on,instance_variable_set,generate_headless_renderer,puts,class,remove_class');
...
;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["parent"], function $$14(values, atome, proc){var self = $$14.$$s == null ? this : $$14.$$s;
    ...
    return $send(values, 'each', [], function $$15(value){var self = $$15.$$s == null ? this : $$15.$$s;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["id"], function $$16(value, atome, proc){
    ...
    if (proc == null) proc = nil;;
    return nil;}, 3);
  $send($$('Genesis'), 'generate_html_renderer', ["left"], function $$17(value, atome, proc){var $a, self = $$17.$$s == null ? this : $$17.$$s;
    if (self.html_type == null) self.html_type = nil;
    if (self.html_object == null) self.html_object = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["right"], function $$18(value, atome, proc){var $a, self = $$18.$$s == null ? this : $$18.$$s;
    if (self.html_type == null) self.html_type = nil;
    if (self.html_object == null) self.html_object = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["top"], function $$19(value, atome, proc){var $a, self = $$19.$$s == null ? this : $$19.$$s;
    if (self.html_type == null) self.html_type = nil;
    if (self.html_object == null) self.html_object = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["bottom"], function $$20(value, atome, proc){var $a, self = $$20.$$s == null ? this : $$20.$$s;
    if (self.html_type == null) self.html_type = nil;
    if (self.html_object == null) self.html_object = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["width"], function $$21(value, atome, proc){var $a, self = $$21.$$s == null ? this : $$21.$$s;
    if (self.html_type == null) self.html_type = nil;
    if (self.html_object == null) self.html_object = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["height"], function $$22(value, atome, proc){var $a, self = $$22.$$s == null ? this : $$22.$$s;
    if (self.html_type == null) self.html_type = nil;
    if (self.html_object == null) self.html_object = nil;
  ...
  $send($$('Genesis'), 'particle_creator', ["rotate"], function $$23(params, atome){var proc = $$23.$$p || nil, self = $$23.$$s == null ? this : $$23.$$s;
