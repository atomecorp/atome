class Device
  ...
  def initialize
    ...
    Atome.new({ atome_id: :view, id: :view, type: :particle, width: "100%", height: "100%", x: 0, y: 0, z: 0, overflow: :auto, parent: :intuition, color: :transparent, tactile: ATOME.is_mobile })
