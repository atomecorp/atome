...
;
  ...
  $send($$('Genesis'), 'atome_creator_option', ["code_pre_render_proc"], function $$47(params){var self = $$47.$$s == null ? this : $$47.$$s, str = nil;
    ...
    $def(self, '$get_binding', function $$get_binding() {
      ...
      return Opal.Binding.$new(  function($code) {    return eval($code);  },  [],  self,  ['atome/kernel/generators/generator.rb', 411])
    }, 0);
    str = params['$[]']("value");
    self.$eval(str, self.$get_binding(), "atome/kernel/generators/generator.rb", 414);
    return params['$[]']("value");}, {$$arity: 1, $$s: self});
