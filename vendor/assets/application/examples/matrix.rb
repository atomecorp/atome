...
# #
# # #######################################################@
# matrix_to_treat = main_matrix.group
...
# end
# main_matrix.group.smooth(9)
# main_matrix.color(:red)
# main_matrix.group.color(:yellow)
# wait 5 do
...
main_matrix.display(false)
  ...
  #   main_matrix = matrix_zone.matrix({ id: :vie_, rows: 8, columns: 8, spacing: 6, size: '100%' })
  #   main_matrix.color(:red)
  end
end
