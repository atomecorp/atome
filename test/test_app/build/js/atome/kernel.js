...
Opal.modules["atome/version"] = function(Opal) {/* Generated by Opal 1.5.1 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    return $const_set($nesting[0], 'VERSION', "0.4.5.5")
...
Opal.modules["atome/kernel/generators/genesis"] = function(Opal) {/* Generated by Opal 1.5.1 */
  ...
  Opal.add_stubs('validation,run_optional_methods_helper,to_sym,broadcaster,history,instance_variable_get,is_a?,instance_exec,to_proc,set_new_particle,get_new_particle,new,atomes_add,instance_variable_set,each,send,create_new_atomes,[],current_user,app_identity,length,atomes,add_essential_properties,sanitizer,set_new_atome,get_new_atome,additional,include,[]=,define_method,renderer_list,define_singleton_method,atome_creator_option,additional_atomes,generate_renderers_methods,atome_list,new_atome,puts,optional_atome_methods,additional_atome_methods,render_engine,optional_particle_methods,particle_list,new_particle,additional_particle_methods');
  ...
  (function($base, $parent_nesting) {
    ...
    $def(self, '$new_particle', function $$new_particle(particle, params, proc) {
      var methodproc = $$new_particle.$$p || nil, self = this;

      delete $$new_particle.$$p;
    ...
    $def(self, '$set_new_atome', function $$set_new_atome(atome, params, proc) {
      ...
      new_atome = self.$create_new_atomes(params['$[]']("value"), instance_var, atome);
    ...
    $def(self, '$get_new_atome', function $$get_new_atome(atome) {
      var self = this, atome_instance_variable = nil, value_getted = nil;
      ...
      return $$('Genesis').$run_optional_methods_helper((("" + (atome)) + "_getter_pre_proc").$to_sym(), $hash2(["value"], {"value": value_getted}));
    }, 1);
  ...
  return (function($base, $parent_nesting) {
    ...
    $defs(self, '$atome_creator', function $$atome_creator(method_name) {
      var methodproc = $$atome_creator.$$p || nil, self = this;
      ...
      $send($$('Atome'), 'define_method', [method_name], function $$14(params){var user_proc = $$14.$$p || nil, self = $$14.$$s == null ? this : $$14.$$s;
        ...
        if (params == null) params = nil;;
        return $send(self, 'new_atome', [method_name, params, user_proc], methodproc.$to_proc());}, {$$arity: -1, $$s: self});
      $send($$('Atome'), 'define_method', ["" + (method_name) + "="], function $$15(params){var user_proc = $$15.$$p || nil, self = $$15.$$s == null ? this : $$15.$$s;
        ...
        if (params == null) params = nil;;
        self.$puts("user_proc is " + (user_proc));
    ...
    return $defs(self, '$particle_creator', function $$particle_creator(method_name) {
      var methodproc = $$particle_creator.$$p || nil, self = this;
      ...
      $send($$('Atome'), 'define_method', [method_name], function $$22(params){var user_proc = $$22.$$p || nil, self = $$22.$$s == null ? this : $$22.$$s;
        ...
        if (params == null) params = nil;;
        return $send(self, 'new_particle', [method_name, params, user_proc], methodproc.$to_proc());}, {$$arity: -1, $$s: self});
...
Opal.modules["atome/kernel/helpers/internal_methods"] = function(Opal) {/* Generated by Opal 1.5.1 */
  var $nesting = [], nil = Opal.nil, $module = Opal.module, $defs = Opal.defs, $send = Opal.send, $def = Opal.def, $return_val = Opal.return_val;

  Opal.add_stubs('text=,puts');
  return (function($base) {
    var self = $module($base, 'Internal');

    
    
    $defs(self, '$read_ruby', function $$read_ruby(file) {
...
fetch('medias/rubies/'+file)
  ...
  .then(text => Opal.eval(text))
    ...
    $defs(self, '$read_text', function $$read_text(file) {
...
fetch('medias/rubies/'+file)
  ...
  .then(text => console.log(text))
    ...
    $def(self, '$text_data', function $$text_data(value) {
      var $a, self = this;
    ...
    $def(self, '$animator_data', function $$animator_data(value) {
      var self = this;

      return self.$puts("send params to naimation engine")
    }, 1);
    return $def(self, '$_data', $return_val(nil), 0);
  })($nesting[0])
};

Opal.modules["atome/kernel/helpers/utilities"] = function(Opal) {/* Generated by Opal 1.5.1 */
...
Opal.modules["atome/kernel/generators/sanitizer"] = function(Opal) {/* Generated by Opal 1.5.1 */
  ...
  Opal.add_stubs('current_user,[]=,[],merge,id,length,atomes,run_optional_methods_helper,to_sym,add_missing_id,add_essential_drm,render,check_parent');
  return (function($base, $parent_nesting) {
...
Opal.modules["atome/kernel/generators/generator"] = function(Opal) {/* Generated by Opal 1.5.1 */
  var self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, $$$ = Opal.$$$, $send = Opal.send, $truthy = Opal.truthy, $eqeq = Opal.eqeq, $hash2 = Opal.hash2, $rb_divide = Opal.rb_divide, $neqeq = Opal.neqeq, $gvars = Opal.gvars, $rb_times = Opal.rb_times, $eqeqeq = Opal.eqeqeq, $def = Opal.def;

  Opal.add_stubs('particle_creator,atome_creator,atome_creator_option,instance_of?,==,downcase,each_with_index,split,gsub,[]=,[],keys,/,to_i,css_rgb,merge,id,each,!=,<<,child,grab,generate_html_renderer,send,is_a?,instance_exec,to_proc,append_to,DOM,atome,div,head,type,green,blue,alpha,inner_html=,*,red,instance_variable_get,class_names,attributes,remove_class,add_class,style,===,to_s,join,on,instance_variable_set,generate_headless_renderer,puts,class,img,default_params,length,atomes,video,instance_variables,particles,delete,iframe,eval,get_binding');
...
;
  ...
  $send($$('Genesis'), 'particle_creator', ["parent"], function $$4(parents){var self = $$4.$$s == null ? this : $$4.$$s;

    
    
    if (parents == null) parents = nil;;
    $send(parents, 'each', [], function $$5(parent){var self = $$5.$$s == null ? this : $$5.$$s;

      
      
      if (parent == null) parent = nil;;
      if ($neqeq(parent, "user_view")) {
        return self.$grab(parent).$child()['$<<'](self.$id())
      } else {
        return nil
      };}, {$$arity: 1, $$s: self});
    return parents;}, {$$arity: 1, $$s: self});
  $send($$('Genesis'), 'atome_creator_option', ["parent_pre_render_proc"], function $$6(params){
    
    
    if (params == null) params = nil;;
    if (!$truthy(params['$[]']("value")['$instance_of?']($$('Array')))) {
      params['$[]=']("value", [params['$[]']("value")])
    };
    return params['$[]']("value");}, 1);
  $$('Genesis').$particle_creator("date");
  $$('Genesis').$particle_creator("location");
  $send($$('Genesis'), 'generate_html_renderer', ["type"], function $$7(value, atome, proc){var self = $$7.$$s == null ? this : $$7.$$s;
    ...
    if (proc == null) proc = nil;;
    self.$send("" + (value) + "_html", value, atome, proc);
    return value;}, {$$arity: 3, $$s: self});
  $send($$('Genesis'), 'generate_html_renderer', ["shape"], function $$8(value, atome, proc){var self = $$8.$$s == null ? this : $$8.$$s, id_found = nil;
    ...
    $send(self, 'DOM', [], function $$9(){var self = $$9.$$s == null ? this : $$9.$$s;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["color"], function $$10(value, atome, proc){var self = $$10.$$s == null ? this : $$10.$$s;
    if ($gvars.document == null) $gvars.document = nil;
    ...
    return $gvars.document.$head()['$<<'](self.$DOM("<style atome='" + (self.$type()) + "' id='" + (self.$id()) + "'></style>"));}, {$$arity: 3, $$s: self});
  $send($$('Genesis'), 'generate_html_renderer', ["red"], function $$11(value, atome, proc){var $a, self = $$11.$$s == null ? this : $$11.$$s, green_found = nil, $ret_or_1 = nil, blue_found = nil, alpha_found = nil;
    if ($gvars.document == null) $gvars.document = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["green"], function $$12(value, atome, proc){var $a, self = $$12.$$s == null ? this : $$12.$$s, red_found = nil, $ret_or_1 = nil, blue_found = nil, alpha_found = nil;
    if ($gvars.document == null) $gvars.document = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["blue"], function $$13(value, atome, proc){var $a, self = $$13.$$s == null ? this : $$13.$$s, red_found = nil, $ret_or_1 = nil, green_found = nil, alpha_found = nil;
    if ($gvars.document == null) $gvars.document = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["alpha"], function $$14(value, atome, proc){var $a, self = $$14.$$s == null ? this : $$14.$$s, red_found = nil, $ret_or_1 = nil, green_found = nil, blue_found = nil;
    if ($gvars.document == null) $gvars.document = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["parent"], function $$15(values, atome, proc){var self = $$15.$$s == null ? this : $$15.$$s;
    ...
    return $send(values, 'each', [], function $$16(value){var self = $$16.$$s == null ? this : $$16.$$s, html_parent = nil;
      ...
      if ($eqeq(self.html_type, "style")) {
        ...
        html_parent = self.$grab(value).$instance_variable_get("@html_object");
        $send(html_parent.$class_names(), 'each', [], function $$17(class_name){var class_to_remove = nil;
          if ($gvars.document == null) $gvars.document = nil;

          
          
          if (class_name == null) class_name = nil;;
          if (($truthy($gvars.document['$[]'](class_name)) && ($truthy($gvars.document['$[]'](class_name).$attributes()['$[]']("atome"))))) {
            
            class_to_remove = $gvars.document['$[]'](class_name).$attributes()['$[]']("id");
            return html_parent.$remove_class(class_to_remove);
          } else {
            return nil
          };}, 1);
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["id"], function $$18(value, atome, proc){
    ...
    if (proc == null) proc = nil;;
    return nil;}, 3);
  $send($$('Genesis'), 'generate_html_renderer', ["left"], function $$19(value, atome, proc){var $a, self = $$19.$$s == null ? this : $$19.$$s;
    if (self.html_type == null) self.html_type = nil;
    if (self.html_object == null) self.html_object = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["right"], function $$20(value, atome, proc){var $a, self = $$20.$$s == null ? this : $$20.$$s;
    if (self.html_type == null) self.html_type = nil;
    if (self.html_object == null) self.html_object = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["top"], function $$21(value, atome, proc){var $a, self = $$21.$$s == null ? this : $$21.$$s;
    if (self.html_type == null) self.html_type = nil;
    if (self.html_object == null) self.html_object = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["bottom"], function $$22(value, atome, proc){var $a, self = $$22.$$s == null ? this : $$22.$$s;
    if (self.html_type == null) self.html_type = nil;
    if (self.html_object == null) self.html_object = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["width"], function $$23(value, atome, proc){var $a, self = $$23.$$s == null ? this : $$23.$$s;
    if (self.html_type == null) self.html_type = nil;
    if (self.html_object == null) self.html_object = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["height"], function $$24(value, atome, proc){var $a, self = $$24.$$s == null ? this : $$24.$$s;
    if (self.html_type == null) self.html_type = nil;
    if (self.html_object == null) self.html_object = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["rotate"], function $$25(value, atome, proc){var $a, self = $$25.$$s == null ? this : $$25.$$s;
    if (self.html_type == null) self.html_type = nil;
    if (self.html_object == null) self.html_object = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["smooth"], function $$26(value, atome, proc){var $a, self = $$26.$$s == null ? this : $$26.$$s, formated_params = nil, $ret_or_1 = nil, properties = nil;
    if (self.html_type == null) self.html_type = nil;
    if (self.html_object == null) self.html_object = nil;
    ...
    if (proc == null) proc = nil;;
    formated_params = ($eqeqeq($$('Array'), ($ret_or_1 = value)) ? (((properties = []), $send(value, 'each', [], function $$27(param){
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["touch"], function $$28(value, atome, proc){var self = $$28.$$s == null ? this : $$28.$$s;
    if (self.html_object == null) self.html_object = nil;
    ...
    if (proc == null) proc = nil;;
    return $send(self.html_object, 'on', ["click"], function $$29(e){var self = $$29.$$s == null ? this : $$29.$$s;
  ...
  $send($$('Genesis'), 'generate_headless_renderer', ["drag"], function $$30(value, atome, user_proc){var self = $$30.$$s == null ? this : $$30.$$s;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["drag"], function $$31(value, atome, user_proc){var self = $$31.$$s == null ? this : $$31.$$s;
    if (self.html_object == null) self.html_object = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["overflow"], function $$32(value, atome, proc){var $a, self = $$32.$$s == null ? this : $$32.$$s;
    if (self.html_type == null) self.html_type = nil;
    if (self.html_object == null) self.html_object = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["image"], function $$33(value, atome, proc){var self = $$33.$$s == null ? this : $$33.$$s, id_found = nil;
    if ($gvars.document == null) $gvars.document = nil;
    ...
    $send(self, 'DOM', [], function $$34(){var self = $$34.$$s == null ? this : $$34.$$s;
  ...
  $send($$('Genesis'), 'atome_creator', ["text"], function $$35(params){var self = $$35.$$s == null ? this : $$35.$$s, default_renderer = nil, generated_id = nil, $ret_or_1 = nil, generated_render = nil, generated_parent = nil, default_params = nil;
    ...
    if ($truthy(params)) {
      ...
      default_params = $hash2(["render", "id", "type", "parent", "visual", "data", "left", "top", "width", "height", "color"], {"render": [generated_render], "id": generated_id, "type": "text", "parent": [generated_parent], "visual": $hash2(["size"], {"size": 33}), "data": "hello world", "left": 39, "top": 33, "width": 199, "height": 33, "color": $hash2(["render", "id", "type", "red", "green", "blue", "alpha"], {"render": [generated_render], "id": "color_" + (generated_id), "type": "color", "red": 0.09, "green": 1, "blue": 0.12, "alpha": 1})});
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["visual"], function $$36(value, atome, proc){var $a, self = $$36.$$s == null ? this : $$36.$$s;
    if (self.html_object == null) self.html_object = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["text"], function $$37(value, atome, proc){var self = $$37.$$s == null ? this : $$37.$$s, id_found = nil;
    if ($gvars.document == null) $gvars.document = nil;
    ...
    $send(self, 'DOM', [], function $$38(){var self = $$38.$$s == null ? this : $$38.$$s;

      return self.$div($hash2(["id"], {"id": id_found})).$atome()}, {$$arity: 0, $$s: self}).$append_to($gvars.document['$[]']("user_view"));
    self.html_object = $gvars.document['$[]'](id_found);
    return (self.html_type = "text");}, {$$arity: 3, $$s: self});
  $send($$('Genesis'), 'atome_creator', ["video"], function $$39(params){var proc = $$39.$$p || nil, self = $$39.$$s == null ? this : $$39.$$s, default_renderer = nil, generated_id = nil, $ret_or_1 = nil, generated_render = nil, generated_parent = nil, default_params = nil;
    ...
    if ($truthy(params)) {
      ...
      generated_parent = ($truthy(($ret_or_1 = params['$[]']("parent"))) ? ($ret_or_1) : (self.$id()));
      default_params = $hash2(["render", "id", "type", "parent", "path", "left", "top", "width", "height"], {"render": [generated_render], "id": generated_id, "type": "video", "parent": [generated_parent], "path": "./medias/videos/video_missing.mp4", "left": 39, "top": 33, "width": 199, "height": 33});
      params = default_params.$merge(params);
    };
    return params;}, {$$arity: 1, $$s: self});
  $send($$('Genesis'), 'generate_html_renderer', ["video"], function $$41(value, atome, proc){var self = $$41.$$s == null ? this : $$41.$$s, id_found = nil;
    if ($gvars.document == null) $gvars.document = nil;
    ...
    $send(self, 'DOM', [], function $$42(){var self = $$42.$$s == null ? this : $$42.$$s;
  ...
  $send($$('Genesis'), 'atome_creator_option', ["particles_getter_pre_proc"], function $$43(params){var atome_found = nil, particles_hash = nil;
    ...
    $send(atome_found.$instance_variables(), 'each', [], function $$44(particle_found){var $a, particle_content = nil;
  ...
  $send($$('Genesis'), 'atome_creator_option', ["link_pre_render_proc"], function $$45(params){var self = $$45.$$s == null ? this : $$45.$$s, atome_found = nil, atome_to_link = nil, particles_found = nil, atome_type = nil, sanitized_particles = nil;
    ...
    $send(particles_found, 'each', [], function $$46(particle_name, value){var $a;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["path"], function $$47(value, atome, proc){var $a, self = $$47.$$s == null ? this : $$47.$$s;
    if (self.html_object == null) self.html_object = nil;
    ...
    if (proc == null) proc = nil;;
    return ($a = ["src", value], $send(self.html_object, '[]=', $a), $a[$a.length - 1]);}, {$$arity: 3, $$s: self});
  $send($$('Genesis'), 'generate_html_renderer', ["web"], function $$48(value, atome, proc){var self = $$48.$$s == null ? this : $$48.$$s, id_found = nil;
    if (self.html_object == null) self.html_object = nil;
    if ($gvars.document == null) $gvars.document = nil;
    ...
    $send(self, 'DOM', [], function $$49(){var self = $$49.$$s == null ? this : $$49.$$s;

      return self.$iframe($hash2(["id"], {"id": id_found})).$atome()}, {$$arity: 0, $$s: self}).$append_to($gvars.document['$[]']("user_view"));
    self.html_object = $gvars.document['$[]'](id_found);
    self.html_object.$attributes()['$[]=']("allow", "accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture");
    self.html_object.$attributes()['$[]=']("allowfullscreen", true);
    return (self.html_type = "web");}, {$$arity: 3, $$s: self});
  $$('Genesis').$particle_creator("data");
  $send($$('Genesis'), 'generate_html_renderer', ["data"], function $$50(value, atome, proc){var self = $$50.$$s == null ? this : $$50.$$s;
  ...
  $send($$('Genesis'), 'atome_creator_option', ["code_pre_render_proc"], function $$51(params){var self = $$51.$$s == null ? this : $$51.$$s, str = nil;
    ...
    $def(self, '$get_binding', function $$get_binding() {
      ...
      return Opal.Binding.$new(  function($code) {    return eval($code);  },  [],  self,  ['atome/kernel/generators/generator.rb', 445])
    }, 0);
    str = params['$[]']("value");
    self.$eval(str, self.$get_binding(), "atome/kernel/generators/generator.rb", 448);
    return params['$[]']("value");}, {$$arity: 1, $$s: self});
  $$('Genesis').$particle_creator("on");
  return $send($$('Genesis'), 'generate_html_renderer', ["on"], function $$52(value, atome, proc){var self = $$52.$$s == null ? this : $$52.$$s;
    if (self.html_object == null) self.html_object = nil;
    ...
    if (proc == null) proc = nil;;
    return $send(self.html_object, 'on', [value], function $$53(e){var self = $$53.$$s == null ? this : $$53.$$s;
...
Opal.modules["atome/renderers/server/properties/generator"] = function(Opal) {/* Generated by Opal 1.5.1 */
  ...
  return (function($base, $parent_nesting) {
    ...
    return $def(self, '$render_server', function $$render_server(params) {
      var proc = $$render_server.$$p || nil, self = this;

      delete $$render_server.$$p;
...
Opal.modules["atome/kernel/generators/shapes"] = function(Opal) {/* Generated by Opal 1.5.1 */
  var self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, $klass = Opal.klass, $hash2 = Opal.hash2, $truthy = Opal.truthy, $send = Opal.send, $def = Opal.def;

  Opal.add_stubs('[],default_params,length,atomes,instance_of?,id,merge,new,to_proc,shape,box,grab,circle,[]=,text,video');
  ...
  (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$box', function $$box(params) {
      var bloc = $$box.$$p || nil, self = this, default_renderer = nil, generated_id = nil, $ret_or_1 = nil, generated_render = nil, generated_parent = nil, temp_default = nil, new_atome = nil;
      ...
      new_atome = $send($$('Atome'), 'new', [$hash2(["shape"], {"shape": params})], bloc.$to_proc());
  ...
  $def(self, '$box', function $$box(params) {
    ...
    if (params == null) params = $hash2([], {});;
    return $send($$('Utilities').$grab("view"), 'box', [params], proc.$to_proc());
  }, -1);
  
  $def(self, '$circle', function $$circle(params) {
    var proc = $$circle.$$p || nil;
    ...
    if (params == null) params = $hash2([], {});;
    return $send($$('Utilities').$grab("view"), 'circle', [params], proc.$to_proc());
  }, -1);
  ...
  $def(self, '$text', function $$text(params) {
    ...
    if (params == null) params = $hash2([], {});;
    params['$[]=']("bloc", bloc);
    return $$('Utilities').$grab("view").$text(params);
  }, -1);
  return $def(self, '$video', function $$video(params) {
    var proc = $$video.$$p || nil;
    ...
    if (params == null) params = $hash2([], {});;
    return $send($$('Utilities').$grab("view"), 'video', [params], proc.$to_proc());
  }, -1);
};
...
Opal.modules["atome/kernel/atome"] = function(Opal) {/* Generated by Opal 1.5.1 */
  ...
  Opal.add_stubs('include,new,===,=~,last_match,downcase,current_machine_decision,now,geolocation,each_with_index,instance_variable_set,each,send,additional_helper,[]=,connected,puts');
  ...
  (function($base, $super, $parent_nesting) {
    ...
    return $def(self, '$initialize', function $$initialize(params) {
      ...
      self.render = [];
      self.child = [];
      params['$[]=']("bloc", $hash2(["bloc"], {"bloc": bloc}));
      return $send(params, 'each', [], function $$3(atome, values){var self = $$3.$$s == null ? this : $$3.$$s, new_atome = nil;
        ...
        if (values == null) values = nil;;
        return (new_atome = self.$send(atome, values));}, {$$arity: 2, $$s: self});
    }, -1);
  })($nesting[0], null, $nesting);
  $$('Universe').$connected();
...
Opal.modules["atome/kernel/properties/essential"] = function(Opal) {/* Generated by Opal 1.5.1 */
  var $nesting = [], nil = Opal.nil, $klass = Opal.klass, $assign_ivar = Opal.assign_ivar, $def = Opal.def, $defs = Opal.defs, $send = Opal.send;

  Opal.add_stubs('puts,grab,each,child,remove,html_object,instance_variable_get,[],instance_variables,to_s,inspect');
  return (function($base, $super, $parent_nesting) {
    var self = $klass($base, $super, 'Atome');
    ...
    $def(self, '$clear', function $$clear() {
      ...
      $send(self.$child(), 'each', [], function $$2(child_found){var $a, self = $$2.$$s == null ? this : $$2.$$s;

        
        
        if (child_found == null) child_found = nil;;
        return ($a = self.$grab(child_found).$html_object(), ($a === nil || $a == null) ? nil : self.$grab(child_found).$html_object().$remove());}, {$$arity: 1, $$s: self});
      return self.$child([]);
    }, 0);
    
    $def(self, '$delete', function $Atome_delete$3(params) {
      var self = this;

      return self.$puts("replace : " + (params))
    }, 1);
    
    $def(self, '$[]', function $Atome_$$$4(params) {
      var self = this;
...
Opal.modules["atome/extensions/helper"] = function(Opal) {/* Generated by Opal 1.5.1 */
  var self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, $def = Opal.def, $rb_times = Opal.rb_times, $truthy = Opal.truthy, $send = Opal.send;

  Opal.add_stubs('include,grab,send,to_f,*,is_a?,instance_exec,to_proc,to_s,split,union,now,length,[]');
  
  self.$include($$('Internal'));
  
  $def(self, '$grab', function $$grab(val) {
    
    return $$('Atome').$grab(val)
  }, 1);
  
  $def(self, '$read', function $$read(file, action) {
    
    
    
    if (action == null) action = "text";;
    return $$('Internal').$send("read_" + (action), file);
  }, -2);
  
  $def(self, '$wait', function $$wait(seconds) {
    var $yield = $$wait.$$p || nil;

    delete $$wait.$$p;
    
    seconds = seconds.$to_f();
    return setTimeout(function(){ Opal.yieldX($yield, []) }, $rb_times(seconds, 1000));
  }, 1);
  ...
  $def(self, '$repeat', function $$repeat(delay, repeat) {
...
;
  ...
  $def(self, '$schedule', function $$schedule(date) {
    var proc = $$schedule.$$p || nil, delimiters = nil, formated_date = nil, missing_datas = nil, missing_datas_formated_date = nil, seconds = nil, minutes = nil, hours = nil, days = nil, months = nil, years = nil;
    ...
    return atome.jsSchedule(years,months,days,hours,minutes,seconds,proc);
  }, 1);
  return $def(self, '$schedule_callback', function $$schedule_callback(proc) {
    var self = this;
...
Opal.modules["atome/kernel/sparkle"] = function(Opal) {/* Generated by Opal 1.5.1 */
  ...
  $$('Atome').$new($hash2(["shape"], {"shape": $hash2(["render", "id", "type", "parent", "left", "right", "top", "bottom", "overflow", "color"], {"render": [default_render], "id": "view", "type": "shape", "parent": ["user_view"], "left": 0, "right": 0, "top": 0, "bottom": 0, "overflow": "auto", "color": $hash2(["render", "id", "type", "red", "green", "blue", "alpha"], {"render": [default_render], "id": "view_color", "type": "color", "red": 0.15, "green": 0.15, "blue": 0.15, "alpha": 1})})}));
...
Opal.queue(function(Opal) {/* Generated by Opal 1.5.1 */
  ...
  $def(self, '$eval_protection', function $$eval_protection() {
    ...
    return Opal.Binding.$new(  function($code) {    return eval($code);  },  [],  self,  ['/Users/jeezs/codes/atome/app_builder_helpers/../lib/atome.rb', 8])
  }, 0);
  if ($neqeq($$('RUBY_ENGINE').$downcase(), "opal")) {
    
    self.$eval("require 'atome/atome_native_extensions'", self.$eval_protection(), "/Users/jeezs/codes/atome/app_builder_helpers/../lib/atome.rb", 15);
    self.$eval("require 'color'", self.$eval_protection(), "/Users/jeezs/codes/atome/app_builder_helpers/../lib/atome.rb", 16);
  };
  self.$require("atome/kernel/universe");
  self.$require("atome/kernel/generators/genesis");
  self.$require("atome/kernel/helpers/internal_methods");
  self.$require("atome/kernel/helpers/utilities");
