...
Opal.modules["atome/kernel/generators/generator"] = function(Opal) {/* Generated by Opal 1.5.1 */
  ...
  Opal.add_stubs('atome_creator,atome_creator_option,instance_of?,==,downcase,each_with_index,split,gsub,[]=,[],keys,/,to_i,css_rgb,merge,id,particle_creator,generate_html_renderer,send,is_a?,instance_exec,to_proc,append_to,DOM,atome,div,<<,head,green,blue,alpha,inner_html=,*,red,add_class,style,===,each,to_s,join,on');
...
;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["smooth"], function $$22(value, atome, proc){var $a, self = $$22.$$s == null ? this : $$22.$$s, formated_params = nil, $ret_or_1 = nil, properties = nil;
    if (self.html_type == null) self.html_type = nil;
    if (self.html_object == null) self.html_object = nil;
    ...
    if (proc == null) proc = nil;;
    formated_params = ($eqeqeq($$('Array'), ($ret_or_1 = value)) ? (((properties = []), $send(value, 'each', [], function $$23(param){
  ...
  return $send($$('Genesis'), 'generate_html_renderer', ["touch"], function $$24(value, atome, proc){var self = $$24.$$s == null ? this : $$24.$$s;
    if (self.html_object == null) self.html_object = nil;
    ...
    if (proc == null) proc = nil;;
    return $send(self.html_object, 'on', ["click"], function $$25(e){var self = $$25.$$s == null ? this : $$25.$$s;
