...
wait 1 do
  a = selected_items.layout({ mode: :grid, width: 500, height: 500 })
  # selected_items.layout({ id: :my_layout, mode: :grid, width: 500, height: 500 })

  wait 1 do
    a = selected_items.layout({ mode: :grid, width: 800, height: 500 })

    wait 1 do
      # selected_items.layout({ id: :my_layout, mode: :list, width: 500, height: 500 })
