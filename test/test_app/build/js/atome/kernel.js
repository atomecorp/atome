...
Opal.modules["atome/kernel/generators/shapes"] = function(Opal) {/* Generated by Opal 1.5.1 */
  ...
  $def(self, '$box', function $$box(params) {
    ...
    temp_default = $hash2(["render", "id", "type", "width", "height", "left", "top", "color"], {"render": ["html"], "id": "box_" + ($$('Universe').$atomes().$length()), "type": "shape", "width": 99, "height": 99, "left": 9, "top": 9, "color": $hash2(["render", "id", "type", "red", "green", "blue", "alpha"], {"render": ["html"], "id": "color_" + ($$('Universe').$atomes().$length()), "type": "color", "red": 0.69, "green": 0.69, "blue": 0.69, "alpha": 1})});
