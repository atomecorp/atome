...
Opal.modules["atome/kernel/generators/generator"] = function(Opal) {/* Generated by Opal 1.5.1 */
  var self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, $$$ = Opal.$$$, $send = Opal.send, $return_val = Opal.return_val, $truthy = Opal.truthy, $eqeq = Opal.eqeq, $hash2 = Opal.hash2, $rb_divide = Opal.rb_divide, $gvars = Opal.gvars, $rb_times = Opal.rb_times, $eqeqeq = Opal.eqeqeq;

  Opal.add_stubs('atome_creator,atome_creator_option,instance_of?,==,downcase,each_with_index,split,gsub,[]=,[],keys,/,to_i,css_rgb,merge,id,particle_creator,generate_html_renderer,send,is_a?,instance_exec,to_proc,append_to,DOM,atome,div,<<,head,green,blue,alpha,inner_html=,*,red,add_class,style,method_name,===,each,to_s,join,on');
...
;
  ...
  return $send($$('Genesis'), 'generate_html_renderer', ["touch"], function $$27(value, atome, proc){var self = $$27.$$s == null ? this : $$27.$$s;
    if (self.html_object == null) self.html_object = nil;
