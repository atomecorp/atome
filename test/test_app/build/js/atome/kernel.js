...
;
  ...
  $send($$('Genesis'), 'particle_creator', ["parent"], function $$4(parents){var self = $$4.$$s == null ? this : $$4.$$s;
    ...
    $send(parents, 'each', [], function $$5(parent){var self = $$5.$$s == null ? this : $$5.$$s;
      ...
      return self.$grab(parent).$child()['$<<'](self.$id());}, {$$arity: 1, $$s: self});
  ...
  return $send($$('Genesis'), 'generate_html_renderer', ["data"], function $$49(value, atome, proc){var self = $$49.$$s == null ? this : $$49.$$s;
