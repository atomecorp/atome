Opal.queue(function(Opal) {/* Generated by Opal 1.5.1 */
  ...
  Opal.add_stubs('box,height,left,smooth,touch,color,length,atomes,top,rotate,alert,new,drag,shape,puts,==,circle,atome_creator,particle_creator,generate_html_renderer,[]=,+,to_s,now,id,is_a?,instance_exec,to_proc,append_to,DOM,atome,img,[],text=,style,div,video,script');
  ...
  text = $$('Atome').$new($hash2(["text"], {"text": $hash2(["render", "id", "type", "parent", "visual", "string", "left", "top", "width", "height"], {"render": ["html"], "id": "text1", "type": "text", "parent": "view", "visual": $hash2(["size"], {"size": 33}), "string": "hello!", "left": 399, "top": 633, "width": 199, "height": 99})}));
  ...
  $send($$('Genesis'), 'particle_creator', ["bloc"], function $$17(){var proc = $$17.$$p || nil, self = $$17.$$s == null ? this : $$17.$$s;

    delete $$17.$$p;
    
    ;
    self.$alert("we should exec the proc");
    if ($truthy(proc['$is_a?']($$('Proc')))) {
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["bloc"], function $$20(value, atome, proc){var self = $$20.$$s == null ? this : $$20.$$s;
    ...
    if (proc == null) proc = nil;;
    return self.$alert(value);}, {$$arity: 3, $$s: self});
  return (animation = $send($$('Atome'), 'new', [$hash2(["animation"], {"animation": $hash2(["render", "id", "type", "target", "code", "left", "top", "width", "height"], {"render": ["html"], "id": "anim1", "type": "animation", "target": "image1", "code": "alert :poil", "left": 333, "top": 333, "width": 199, "height": 99})})], function $$21(){var self = $$21.$$s == null ? this : $$21.$$s;

    return self.$alert("soog")}, {$$arity: 0, $$s: self}));
});
