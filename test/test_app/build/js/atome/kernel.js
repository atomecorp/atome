...
Opal.modules["atome/version"] = function(Opal) {/* Generated by Opal 1.5.1 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    return $const_set($nesting[0], 'VERSION', "0.436")
...
Opal.queue(function(Opal) {/* Generated by Opal 1.5.1 */
  ...
  $def(self, '$eval_protection', function $$eval_protection() {
    ...
    return Opal.Binding.$new(  function($code) {    return eval($code);  },  [],  self,  ['/Users/jean-ericgodard/.rbenv/versions/3.1.1/lib/ruby/gems/3.1.0/gems/atome-0.436/app_builder_helpers/../lib/atome.rb', 7])
  }, 0);
  if ($neqeq($$('RUBY_ENGINE').$downcase(), "opal")) {
    self.$eval("require 'atome/atome_native_extensions'", self.$eval_protection(), "/Users/jean-ericgodard/.rbenv/versions/3.1.1/lib/ruby/gems/3.1.0/gems/atome-0.436/app_builder_helpers/../lib/atome.rb", 13)
  };
