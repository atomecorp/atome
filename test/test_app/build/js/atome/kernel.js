...
Opal.modules["atome/version"] = function(Opal) {/* Generated by Opal 1.5.1 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    return $const_set($nesting[0], 'VERSION', "0.443")
...
Opal.modules["atome/kernel/generators/genesis"] = function(Opal) {/* Generated by Opal 1.5.1 */
  ...
  (function($base, $parent_nesting) {
    ...
    $def(self, '$set_new_atome', function $$set_new_atome(atome, params, proc) {
      ...
      self.$puts("atome : " + (atome) + " ");
      instance_var = "@" + (atome);
      params = $$('Genesis').$run_optional_methods_helper((("" + (atome)) + "_pre_save_proc").$to_sym(), $hash2(["params", "proc"], {"params": params, "proc": proc}));
  ...
  return (function($base, $parent_nesting) {
    ...
    $defs(self, '$optional_atome_methods', function $$optional_atome_methods(method_name) {
      ...
      return $send($$('Genesis'), 'atome_creator_option', [(("" + (method_name)) + "_pre_save_proc").$to_sym()], function $$8(params, proc){
    ...
    $defs(self, '$additional_atome_methods', function $$additional_atome_methods(method_name) {
      ...
      $send($$('Atome'), 'define_method', ["" + (method_name) + "s"], function $$9(params){var self = $$9.$$s == null ? this : $$9.$$s;

        
        
        if (params == null) params = nil;;
        return self.$additional_atomes(method_name, params);}, {$$arity: -1, $$s: self});
      $send($$('Atome'), 'define_method', ["set_" + (method_name)], function $$10(params){var proc = $$10.$$p || nil, self = $$10.$$s == null ? this : $$10.$$s;
      ...
      $send($$('Atome'), 'define_method', ["get_" + (method_name)], function $$11(){var self = $$11.$$s == null ? this : $$11.$$s;
    ...
    $defs(self, '$atome_creator', function $$atome_creator(method_name) {
      ...
      $send($$('Atome'), 'define_method', [method_name], function $$12(params){var user_proc = $$12.$$p || nil, self = $$12.$$s == null ? this : $$12.$$s;
      ...
      $send($$('Atome'), 'define_method', ["" + (method_name) + "="], function $$13(params){var user_proc = $$13.$$p || nil, self = $$13.$$s == null ? this : $$13.$$s;
    ...
    $defs(self, '$optional_particle_methods', function $$optional_particle_methods(method_name) {
      ...
      $send($$('Genesis'), 'atome_creator_option', [(("" + (method_name)) + "_render_proc").$to_sym()], function $$14(params){
        
        
        if (params == null) params = nil;;
        $send(params['$[]']("atome"), 'render_engine', [params['$[]']("method"), params['$[]']("value"), params['$[]']("atome")], params['$[]']("proc").$to_proc());
        return params['$[]']("value");}, 1);
      $send($$('Genesis'), 'atome_creator_option', [(("" + (method_name)) + "_pre_render_proc").$to_sym()], function $$15(params){var particle_instance_variable = nil;
        ...
        return params['$[]']("value");}, 1);
      return $send($$('Genesis'), 'atome_creator_option', [(("" + (method_name)) + "_post_render_proc").$to_sym()], function $$16(params){
    ...
    $defs(self, '$additional_particle_methods', function $$additional_particle_methods(method_name) {
      ...
      $send($$('Atome'), 'define_method', ["set_" + (method_name)], function $$17(params){var proc = $$17.$$p || nil, self = $$17.$$s == null ? this : $$17.$$s;
      ...
      $send($$('Atome'), 'define_method', ["get_" + (method_name)], function $$18(){var self = $$18.$$s == null ? this : $$18.$$s;
    ...
    return $defs(self, '$particle_creator', function $$particle_creator(method_name) {
      ...
      $send($$('Atome'), 'define_method', [method_name], function $$19(params){var user_proc = $$19.$$p || nil, self = $$19.$$s == null ? this : $$19.$$s;
...
Opal.modules["atome/kernel/generators/sanitizer"] = function(Opal) {/* Generated by Opal 1.5.1 */
  ...
  Opal.add_stubs('current_user,[]=,[],merge,id,length,atomes,add_missing_id,add_essential_drm,default_params,check_parent');
  return (function($base, $parent_nesting) {
...
Opal.modules["atome/kernel/generators/generator"] = function(Opal) {/* Generated by Opal 1.5.1 */
  var self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, $send = Opal.send, $return_val = Opal.return_val, $truthy = Opal.truthy, $hash2 = Opal.hash2, $gvars = Opal.gvars, $rb_times = Opal.rb_times, $eqeq = Opal.eqeq, $eqeqeq = Opal.eqeqeq;

  Opal.add_stubs('atome_creator,particle_creator,atome_creator_option,[],generate_html_renderer,send,id,is_a?,instance_exec,to_proc,append_to,DOM,atome,div,<<,head,green,blue,alpha,inner_html=,*,red,==,add_class,[]=,style,===,each,to_s,join,on');
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["type"], function $$2(value, atome, proc){var self = $$2.$$s == null ? this : $$2.$$s;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["shape"], function $$3(value, atome, proc){var self = $$3.$$s == null ? this : $$3.$$s, id_found = nil;
    ...
    $send(self, 'DOM', [], function $$4(){var self = $$4.$$s == null ? this : $$4.$$s;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["color"], function $$5(value, atome, proc){var self = $$5.$$s == null ? this : $$5.$$s;
    if ($gvars.document == null) $gvars.document = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["red"], function $$6(value, atome, proc){var $a, self = $$6.$$s == null ? this : $$6.$$s, green_found = nil, $ret_or_1 = nil, blue_found = nil, alpha_found = nil;
    if ($gvars.document == null) $gvars.document = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["green"], function $$7(value, atome, proc){var $a, self = $$7.$$s == null ? this : $$7.$$s, red_found = nil, $ret_or_1 = nil, blue_found = nil, alpha_found = nil;
    if ($gvars.document == null) $gvars.document = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["blue"], function $$8(value, atome, proc){var $a, self = $$8.$$s == null ? this : $$8.$$s, red_found = nil, $ret_or_1 = nil, green_found = nil, alpha_found = nil;
    if ($gvars.document == null) $gvars.document = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["alpha"], function $$9(value, atome, proc){var $a, self = $$9.$$s == null ? this : $$9.$$s, red_found = nil, $ret_or_1 = nil, green_found = nil, blue_found = nil;
    if ($gvars.document == null) $gvars.document = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["drm"], function $$10(value, atome, proc){
    ...
    if (proc == null) proc = nil;;
    return nil;}, 3);
  $send($$('Genesis'), 'generate_html_renderer', ["parent"], function $$11(value, atome, proc){var self = $$11.$$s == null ? this : $$11.$$s;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["id"], function $$12(value, atome, proc){
    ...
    if (proc == null) proc = nil;;
    return nil;}, 3);
  $send($$('Genesis'), 'generate_html_renderer', ["left"], function $$13(value, atome, proc){var $a, self = $$13.$$s == null ? this : $$13.$$s;
    if (self.html_type == null) self.html_type = nil;
    if (self.html_object == null) self.html_object = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["right"], function $$14(value, atome, proc){var $a, self = $$14.$$s == null ? this : $$14.$$s;
    if (self.html_type == null) self.html_type = nil;
    if (self.html_object == null) self.html_object = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["top"], function $$15(value, atome, proc){var $a, self = $$15.$$s == null ? this : $$15.$$s;
    if (self.html_type == null) self.html_type = nil;
    if (self.html_object == null) self.html_object = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["bottom"], function $$16(value, atome, proc){var $a, self = $$16.$$s == null ? this : $$16.$$s;
    if (self.html_type == null) self.html_type = nil;
    if (self.html_object == null) self.html_object = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["width"], function $$17(value, atome, proc){var $a, self = $$17.$$s == null ? this : $$17.$$s;
    if (self.html_type == null) self.html_type = nil;
    if (self.html_object == null) self.html_object = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["height"], function $$18(value, atome, proc){var $a, self = $$18.$$s == null ? this : $$18.$$s;
    if (self.html_type == null) self.html_type = nil;
    if (self.html_object == null) self.html_object = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["smooth"], function $$19(value, atome, proc){var $a, self = $$19.$$s == null ? this : $$19.$$s, formated_params = nil, $ret_or_1 = nil, properties = nil;
    if (self.html_type == null) self.html_type = nil;
    if (self.html_object == null) self.html_object = nil;
    ...
    if (proc == null) proc = nil;;
    formated_params = ($eqeqeq($$('Array'), ($ret_or_1 = value)) ? (((properties = []), $send(value, 'each', [], function $$20(param){
  ...
  return $send($$('Genesis'), 'generate_html_renderer', ["touch"], function $$21(value, atome, proc){var self = $$21.$$s == null ? this : $$21.$$s;
    if (self.html_object == null) self.html_object = nil;
    ...
    if (proc == null) proc = nil;;
    return $send(self.html_object, 'on', ["click"], function $$22(e){var self = $$22.$$s == null ? this : $$22.$$s;
...
Opal.modules["atome/kernel/generators/shapes"] = function(Opal) {/* Generated by Opal 1.5.1 */
  ...
  Opal.add_stubs('[],default_params,length,atomes,instance_of?,id,merge,new,box,grab,circle');
  ...
  (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$box', function $$box(params) {
      var self = this, default_renderer = nil, generated_id = nil, $ret_or_1 = nil, generated_render = nil, generated_parent = nil, temp_default = nil;
...
Opal.modules["atome/kernel/sparkle"] = function(Opal) {/* Generated by Opal 1.5.1 */
  ...
  Opal.add_stubs('==,downcase,[]=,default_params,ready,new');
  if ($eqeq($$('RUBY_ENGINE').$downcase(), "opal")) {
    
    $$('Sanitizer').$default_params()['$[]=']("render", "html");
    return $send($gvars.document, 'ready', [], function $$1(){
      return $$('Atome').$new($hash2(["render", "id", "type", "parent", "left", "right", "top", "bottom", "color"], {"render": ["html"], "id": "view", "type": "shape", "parent": "user_view", "left": 0, "right": 0, "top": 0, "bottom": 0, "color": $hash2(["render", "id", "type", "red", "green", "blue", "alpha"], {"render": ["html"], "id": "c1", "type": "color", "red": 0.15, "green": 0.15, "blue": 0.15, "alpha": 1})}))}, 0);
  } else {
    
    $$('Sanitizer').$default_params()['$[]=']("render", "headless");
    return $$('Atome').$new($hash2(["render", "id", "type", "parent", "left", "right", "top", "bottom", "color"], {"render": ["headless"], "id": "view", "type": "shape", "parent": "user_view", "left": 0, "right": 0, "top": 0, "bottom": 0, "color": $hash2(["render", "id", "type", "red", "green", "blue", "alpha"], {"render": ["headless"], "id": "c1", "type": "color", "red": 0.15, "green": 0.15, "blue": 0.15, "alpha": 1})}));
  }
};
