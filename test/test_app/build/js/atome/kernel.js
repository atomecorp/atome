...
Opal.modules["atome/kernel/generators/generator"] = function(Opal) {/* Generated by Opal 1.5.1 */
  ...
  Opal.add_stubs('particle_creator,atome_creator,atome_creator_option,instance_of?,==,downcase,each_with_index,split,gsub,[]=,[],keys,/,to_i,css_rgb,merge,id,each,!=,<<,child,grab,generate_html_renderer,send,is_a?,instance_exec,to_proc,append_to,DOM,atome,div,head,type,green,blue,alpha,inner_html=,*,red,instance_variable_get,class_names,attributes,remove_class,add_class,style,===,to_s,join,on,instance_variable_set,generate_headless_renderer,puts,class,img,default_params,length,atomes,instance_variables,particles,delete,iframe,eval,get_binding');
...
;
  ...
  $send($$('Genesis'), 'atome_creator_option', ["particles_getter_pre_proc"], function $$39(params){var atome_found = nil, particles_hash = nil;
    ...
    $send(atome_found.$instance_variables(), 'each', [], function $$40(particle_found){var $a, particle_content = nil;
  ...
  $send($$('Genesis'), 'atome_creator_option', ["link_pre_render_proc"], function $$41(params){var self = $$41.$$s == null ? this : $$41.$$s, atome_found = nil, atome_to_link = nil, particles_found = nil, atome_type = nil, sanitized_particles = nil;
    ...
    $send(particles_found, 'each', [], function $$42(particle_name, value){var $a;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["path"], function $$43(value, atome, proc){var $a, self = $$43.$$s == null ? this : $$43.$$s;
    if (self.html_object == null) self.html_object = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["web"], function $$44(value, atome, proc){var self = $$44.$$s == null ? this : $$44.$$s, id_found = nil;
    if (self.html_object == null) self.html_object = nil;
    if ($gvars.document == null) $gvars.document = nil;
    ...
    $send(self, 'DOM', [], function $$45(){var self = $$45.$$s == null ? this : $$45.$$s;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["data"], function $$46(value, atome, proc){var self = $$46.$$s == null ? this : $$46.$$s;
  ...
  $send($$('Genesis'), 'atome_creator_option', ["code_pre_render_proc"], function $$47(params){var self = $$47.$$s == null ? this : $$47.$$s, str = nil;
    ...
    $def(self, '$get_binding', function $$get_binding() {
      ...
      return Opal.Binding.$new(  function($code) {    return eval($code);  },  [],  self,  ['atome/kernel/generators/generator.rb', 418])
    }, 0);
    str = params['$[]']("value");
    self.$eval(str, self.$get_binding(), "atome/kernel/generators/generator.rb", 421);
    return params['$[]']("value");}, {$$arity: 1, $$s: self});
  $$('Genesis').$particle_creator("on");
  return $send($$('Genesis'), 'generate_html_renderer', ["on"], function $$48(value, atome, proc){var self = $$48.$$s == null ? this : $$48.$$s;
    if (self.html_object == null) self.html_object = nil;
    ...
    if (proc == null) proc = nil;;
    return $send(self.html_object, 'on', [value], function $$49(e){var self = $$49.$$s == null ? this : $$49.$$s;
...
Opal.modules["atome/kernel/generators/shapes"] = function(Opal) {/* Generated by Opal 1.5.1 */
  ...
  Opal.add_stubs('[],default_params,length,atomes,instance_of?,id,merge,new,to_proc,shape,box,grab,circle,[]=,text');
  ...
  return $def(self, '$text', function $$text(params) {
    var bloc = $$text.$$p || nil;
...
Opal.queue(function(Opal) {/* Generated by Opal 1.5.1 */
  ...
  $def(self, '$eval_protection', function $$eval_protection() {
    ...
    return Opal.Binding.$new(  function($code) {    return eval($code);  },  [],  self,  ['/Users/jeezs/RubymineProjects/atome/app_builder_helpers/../lib/atome.rb', 8])
  }, 0);
  if ($neqeq($$('RUBY_ENGINE').$downcase(), "opal")) {
    
    self.$eval("require 'atome/atome_native_extensions'", self.$eval_protection(), "/Users/jeezs/RubymineProjects/atome/app_builder_helpers/../lib/atome.rb", 15);
    self.$eval("require 'color'", self.$eval_protection(), "/Users/jeezs/RubymineProjects/atome/app_builder_helpers/../lib/atome.rb", 16);
  };
