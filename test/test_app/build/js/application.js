Opal.queue(function(Opal) {/* Generated by Opal 1.5.1 */
  var self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, $hash2 = Opal.hash2, $send = Opal.send, $eqeq = Opal.eqeq, $rb_plus = Opal.rb_plus, $truthy = Opal.truthy, $gvars = Opal.gvars, b = nil, c = nil, a = nil, image = nil, text = nil, video = nil, animation = nil, bb = nil;

  Opal.add_stubs('box,height,left,smooth,touch,color,length,atomes,top,rotate,alert,new,drag,shape,puts,==,circle,atome_creator,particle_creator,generate_html_renderer,[]=,+,to_s,now,id,is_a?,instance_exec,to_proc,append_to,DOM,atome,img,[],text=,style,div,string,text,video,script,atome_creator_option,class,inspect,each,instance_variables,instance_variable_get,particles,grab,delete,gsub,send,link,parent,red');
  ...
  animation = $send($$('Atome'), 'new', [$hash2(["animation"], {"animation": $hash2(["render", "id", "type", "parent", "target", "code", "left", "top", "width", "height"], {"render": ["html"], "id": "anim1", "type": "animation", "parent": ["view"], "target": "image1", "code": "alert :poil", "left": 333, "top": 333, "width": 199, "height": 99})})], function $$20(){var self = $$20.$$s == null ? this : $$20.$$s;

    return self.$puts(" proc exec added at atome creation level : " + (self.$class()))}, {$$arity: 0, $$s: self});
  self.$alert(animation.$inspect());
  ...
  self.$puts("particles for atome color c315 :: " + ($$('Utilities').$grab("c315").$particles()));
  $$('Genesis').$particle_creator("link");
  $$('Genesis').$particle_creator("html_type");
  $$('Genesis').$particle_creator("html_object");
  $send($$('Genesis'), 'atome_creator_option', ["link_pre_render_proc"], function $$23(params){var self = $$23.$$s == null ? this : $$23.$$s, atome_found = nil, atome_to_link = nil, particles_found = nil, atome_type = nil, sanitized_particles = nil;
  ...
  self.$puts("*******");
  self.$grab("c315").$red(0);
  a = self.$circle($hash2(["id", "color"], {"id": "circle_123", "color": "cyan"}));
  b = self.$box($hash2(["id", "left"], {"id": "box_1", "left": 333}));
  bb = self.$box($hash2(["top"], {"top": 99}));
  self.$grab("box_1").$parent("circle_123");
  self.$grab("color_circle_123").$parent(["box_1"]);
  return bb.$parent(["box_1"]);
});
