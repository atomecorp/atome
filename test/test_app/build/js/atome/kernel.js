...
Opal.modules["atome/kernel/generators/genesis"] = function(Opal) {/* Generated by Opal 1.5.1 */
  ...
  Opal.add_stubs('validation,run_optional_methods_helper,to_sym,broadcaster,history,instance_variable_get,set_new_particle,to_proc,get_new_particle,new,instance_variable_set,each,send,create_new_atomes,[],current_user,app_identity,length,atomes,add_essential_properties,sanitizer,set_new_atome,get_new_atome,additional,include,[]=,is_a?,instance_exec,define_method,renderer_list,define_singleton_method,atome_creator_option,additional_atomes,generate_renderers_methods,atome_list,new_atome,optional_atome_methods,additional_atome_methods,render_engine,optional_particle_methods,particle_list,new_particle,additional_particle_methods');
...
fetch('medias/rubies/'+file)
  ...
  .then(text => Opal.eval(text))
    ...
    return $defs(self, '$read_text', function $$read_text(file) {
...
;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["path"], function $$46(value, atome, proc){var $a, self = $$46.$$s == null ? this : $$46.$$s;
    ...
    if (proc == null) proc = nil;;
    return ($a = ["src", value], $send(self.html_object, '[]=', $a), $a[$a.length - 1]);}, {$$arity: 3, $$s: self});
  return $send($$('Genesis'), 'generate_html_renderer', ["web"], function $$47(value, atome, proc){var self = $$47.$$s == null ? this : $$47.$$s, id_found = nil;
    if (self.html_object == null) self.html_object = nil;
    if ($gvars.document == null) $gvars.document = nil;
...
Opal.modules["atome/kernel/generators/shapes"] = function(Opal) {/* Generated by Opal 1.5.1 */
  ...
  Opal.add_stubs('[],default_params,length,atomes,instance_of?,id,merge,new,shape,text,box,grab,circle,write');
  ...
  return $def(self, '$write_text', function $$write_text(params) {
    
    
    
    if (params == null) params = $hash2([], {});;
    return $$('Utilities').$grab("view").$write(params);
  }, -1);
};
