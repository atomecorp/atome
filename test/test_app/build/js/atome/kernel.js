...
Opal.modules["atome/kernel/atome"] = function(Opal) {/* Generated by Opal 1.5.1 */
  var self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, $$$ = Opal.$$$, $klass = Opal.klass, $defs = Opal.defs, $eqeqeq = Opal.eqeqeq, $truthy = Opal.truthy, $return_ivar = Opal.return_ivar, $assign_ivar = Opal.assign_ivar, $hash2 = Opal.hash2, $def = Opal.def, $send = Opal.send, $gvars = Opal.gvars;

  Opal.add_stubs('include,new,===,=~,last_match,downcase,current_machine_decision,now,geolocation,each_with_index,instance_variable_set,each,send,additional_helper,is_a?,merge,atomes_add,connected,puts');
  ...
  (function($base, $super, $parent_nesting) {
    ...
    return $def(self, '$initialize', function $$initialize(params) {
      var proc = $$initialize.$$p || nil, self = this, bloc = nil;
      if ($gvars.proc == null) $gvars.proc = nil;
      ...
      bloc = $gvars.proc;
      if ($truthy(proc['$is_a?']($$('Proc')))) {
        params = $hash2(["bloc"], {"bloc": $hash2(["code"], {"code": bloc})}).$merge(params)
      };
