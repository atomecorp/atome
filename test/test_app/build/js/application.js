Opal.queue(function(Opal) {/* Generated by Opal 1.5.1 */
  ...
  Opal.add_stubs('box,height,left,smooth,touch,color,length,atomes,top,rotate,alert,new,drag,shape,puts,==,circle,atome_creator,particle_creator,generate_html_renderer,inspect,[]=,+,to_s,now,id,is_a?,instance_exec,to_proc,append_to,DOM,atome,img,[],text=,style,div,video');
  ...
  image = $$('Atome').$new($hash2(["image"], {"image": $hash2(["render", "id", "type", "parent", "path", "left", "top", "width", "height"], {"render": ["html"], "id": "image_12", "type": "image", "parent": "view", "path": "./medias/images/boat.png", "left": 99, "top": 120, "width": 199, "height": 199})}));
  ...
  text = $$('Atome').$new($hash2(["image"], {"image": $hash2(["render", "id", "type", "parent", "visual", "string", "left", "top", "width", "height"], {"render": ["html"], "id": "text1", "type": "text", "parent": "view", "visual": $hash2(["size"], {"size": 33}), "string": "hello!", "left": 399, "top": 633, "width": 199, "height": 99})}));
