Opal.queue(function(Opal) {/* Generated by Opal 1.5.1 */
  ...
  Opal.add_stubs('box,height,left,smooth,touch,color,length,atomes,top,particle_creator,rotate,puts,generate_headless_renderer,class,is_a?,instance_exec,to_proc,generate_html_renderer,new,drag,shape,circle');
