...
atome_monitoring = ['app/temp/media_list.rb', 'opal_compiler/lib/opal_addon.rb', 'renderers/html.rb', 'app/app.rb', 'atome/lib/atome/big_bang.rb', 'atome/lib/atome/core/atome.rb', 'atome/lib/atome/core/electron.rb', 'atome/lib/atome/core/neutron.rb', 'atome/lib/atome/core/photon.rb', 'atome/lib/atome/core/proton.rb'] + Dir.glob('app//*')
