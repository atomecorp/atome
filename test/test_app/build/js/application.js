Opal.queue(function(Opal) {/* Generated by Opal 1.5.1 */
  ...
  Opal.add_stubs('particle_creator,[]=,style,html_object,[],play,puts,currentTime,on,wait,currentTime=,pause,bloc,is_a?,instance_exec,to_proc,atome_creator_option,send,type,generate_html_renderer,new,video,time,grab,text,box,touch');
  ...
  $def(self, '$play_video', function $$play_video(params) {
    ...
    $send(params['$[]']("atome").$html_object(), 'on', ["timeupdate"], function $$1(e){var self = $$1.$$s == null ? this : $$1.$$s;

      
      
      if (e == null) e = nil;;
      return self.$puts("--- " + (params['$[]']("atome").$html_object().$currentTime()) + ":::" + (e));}, {$$arity: 1, $$s: self});
    $send(self, 'wait', [2], function $$2(){var $a;

      return ($a = [33], $send(params['$[]']("atome").$html_object(), 'currentTime=', $a), $a[$a.length - 1])}, 0);
    $send(self, 'wait', [6], function $$3(){
  ...
  $send($$('Genesis'), 'atome_creator_option', ["play_pre_render_proc"], function $$4(params){var self = $$4.$$s == null ? this : $$4.$$s, proc_found = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["time"], function $$5(value, atome, proc){var $a, self = $$5.$$s == null ? this : $$5.$$s;
  ...
  my_video = $send($$('Atome'), 'new', [$hash2(["video"], {"video": $hash2(["render", "data", "id", "type", "parent", "path", "left", "top", "width", "height"], {"render": ["html"], "data": "dummy", "id": "video1", "type": "video", "parent": ["view"], "path": "./medias/videos/avengers.mp4", "left": 333, "top": 333, "width": 199, "height": 99})})], function $$6(params){var self = $$6.$$s == null ? this : $$6.$$s;
  ...
  $send(self.$grab("video1"), 'on', ["pause"], function $$7(event){var self = $$7.$$s == null ? this : $$7.$$s;
  ...
  b = self.$box();
  return $send(b, 'touch', [true], function $$8(){var self = $$8.$$s == null ? this : $$8.$$s;

    return $send(self.$grab("video1"), 'play', [true], function $$9(event){var self = $$9.$$s == null ? this : $$9.$$s;
