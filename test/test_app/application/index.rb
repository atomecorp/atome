...
# TODO : now we need to pass the params to the js drag

#TODO: when we add a color we must change the code : do we create a new color wiythit's id or do we replace the old one?
b.color(:red)
