...
Opal.modules["atome/kernel/generators/genesis"] = function(Opal) {/* Generated by Opal 1.5.1 */
  ...
  Opal.add_stubs('validation,run_optional_methods_helper,to_sym,broadcaster,history,instance_variable_get,set_new_particle,to_proc,get_new_particle,new,instance_variable_set,each,send,create_new_atomes,[],current_user,app_identity,length,atomes,is_a?,instance_exec,add_essential_properties,sanitizer,set_new_atome,get_new_atome,additional,include,[]=,define_method,renderer_list,define_singleton_method,atome_creator_option,additional_atomes,generate_renderers_methods,atome_list,new_atome,optional_atome_methods,additional_atome_methods,render_engine,optional_particle_methods,particle_list,new_particle,additional_particle_methods');
...
Opal.modules["atome/kernel/generators/generator"] = function(Opal) {/* Generated by Opal 1.5.1 */
  ...
  Opal.add_stubs('particle_creator,atome_creator,atome_creator_option,instance_of?,==,downcase,each_with_index,split,gsub,[]=,[],keys,/,to_i,css_rgb,merge,id,generate_html_renderer,send,is_a?,instance_exec,to_proc,append_to,DOM,atome,div,<<,head,type,green,blue,alpha,inner_html=,*,red,each,instance_variable_get,grab,class_names,attributes,remove_class,add_class,style,method_name,===,to_s,join,on,instance_variable_set,generate_headless_renderer,puts,class,img,default_params,length,atomes,video,instance_variables,particles,delete,iframe');
...
;
  ...
  $send($$('Genesis'), 'atome_creator_option', ["parent_pre_render_proc"], function $$4(params){
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["type"], function $$5(value, atome, proc){var self = $$5.$$s == null ? this : $$5.$$s;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["shape"], function $$6(value, atome, proc){var self = $$6.$$s == null ? this : $$6.$$s, id_found = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["color"], function $$8(value, atome, proc){var self = $$8.$$s == null ? this : $$8.$$s;
    if ($gvars.document == null) $gvars.document = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["red"], function $$9(value, atome, proc){var $a, self = $$9.$$s == null ? this : $$9.$$s, green_found = nil, $ret_or_1 = nil, blue_found = nil, alpha_found = nil;
    if ($gvars.document == null) $gvars.document = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["green"], function $$10(value, atome, proc){var $a, self = $$10.$$s == null ? this : $$10.$$s, red_found = nil, $ret_or_1 = nil, blue_found = nil, alpha_found = nil;
    if ($gvars.document == null) $gvars.document = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["blue"], function $$11(value, atome, proc){var $a, self = $$11.$$s == null ? this : $$11.$$s, red_found = nil, $ret_or_1 = nil, green_found = nil, alpha_found = nil;
    if ($gvars.document == null) $gvars.document = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["alpha"], function $$12(value, atome, proc){var $a, self = $$12.$$s == null ? this : $$12.$$s, red_found = nil, $ret_or_1 = nil, green_found = nil, blue_found = nil;
    if ($gvars.document == null) $gvars.document = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["drm"], function $$13(value, atome, proc){
    ...
    if (proc == null) proc = nil;;
    return nil;}, 3);
  $send($$('Genesis'), 'generate_html_renderer', ["parent"], function $$14(values, atome, proc){var self = $$14.$$s == null ? this : $$14.$$s;
    ...
    return $send(values, 'each', [], function $$15(value){var self = $$15.$$s == null ? this : $$15.$$s, html_parent = nil;
      ...
      if ($eqeq(self.html_type, "style")) {
        ...
        $send(html_parent.$class_names(), 'each', [], function $$16(class_name){var class_to_remove = nil;
          if ($gvars.document == null) $gvars.document = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["id"], function $$17(value, atome, proc){
    ...
    if (proc == null) proc = nil;;
    return nil;}, 3);
  $send($$('Genesis'), 'generate_html_renderer', ["left"], function $$18(value, atome, proc){var $a, self = $$18.$$s == null ? this : $$18.$$s;
    if (self.html_type == null) self.html_type = nil;
    if (self.html_object == null) self.html_object = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["right"], function $$19(value, atome, proc){var $a, self = $$19.$$s == null ? this : $$19.$$s;
    if (self.html_type == null) self.html_type = nil;
    if (self.html_object == null) self.html_object = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["top"], function $$20(value, atome, proc){var $a, self = $$20.$$s == null ? this : $$20.$$s;
    if (self.html_type == null) self.html_type = nil;
    if (self.html_object == null) self.html_object = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["bottom"], function $$21(value, atome, proc){var $a, self = $$21.$$s == null ? this : $$21.$$s;
    if (self.html_type == null) self.html_type = nil;
    if (self.html_object == null) self.html_object = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["width"], function $$22(value, atome, proc){var $a, self = $$22.$$s == null ? this : $$22.$$s;
    if (self.html_type == null) self.html_type = nil;
    if (self.html_object == null) self.html_object = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["height"], function $$23(value, atome, proc){var $a, self = $$23.$$s == null ? this : $$23.$$s;
    if (self.html_type == null) self.html_type = nil;
    if (self.html_object == null) self.html_object = nil;
  ...
  $send($$('Genesis'), 'particle_creator', ["rotate"], function $$24(params, atome){var proc = $$24.$$p || nil, self = $$24.$$s == null ? this : $$24.$$s;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["path"], function $$34(value, atome, proc){var $a, self = $$34.$$s == null ? this : $$34.$$s;
    if (self.html_object == null) self.html_object = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["image"], function $$35(value, atome, proc){var self = $$35.$$s == null ? this : $$35.$$s, id_found = nil;
    if ($gvars.document == null) $gvars.document = nil;
    ...
    $send(self, 'DOM', [], function $$36(){var self = $$36.$$s == null ? this : $$36.$$s;
  ...
  $send($$('Genesis'), 'atome_creator', ["text"], function $$37(params){var self = $$37.$$s == null ? this : $$37.$$s, default_renderer = nil, generated_id = nil, $ret_or_1 = nil, generated_render = nil, generated_parent = nil, default_params = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["visual"], function $$38(value, atome, proc){var $a, self = $$38.$$s == null ? this : $$38.$$s;
    if (self.html_object == null) self.html_object = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["text"], function $$39(value, atome, proc){var self = $$39.$$s == null ? this : $$39.$$s, id_found = nil;
    if ($gvars.document == null) $gvars.document = nil;
    ...
    $send(self, 'DOM', [], function $$40(){var self = $$40.$$s == null ? this : $$40.$$s;
  ...
  return $send($$('Genesis'), 'generate_html_renderer', ["data"], function $$50(value, atome, proc){var self = $$50.$$s == null ? this : $$50.$$s;
