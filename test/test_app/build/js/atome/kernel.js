...
;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["drm"], function $$15(value, atome, proc){
    ...
    if (proc == null) proc = nil;;
    return nil;}, 3);
  $send($$('Genesis'), 'generate_html_renderer', ["parent"], function $$16(values, atome, proc){var self = $$16.$$s == null ? this : $$16.$$s;
    ...
    return $send(values, 'each', [], function $$17(value){var self = $$17.$$s == null ? this : $$17.$$s, html_parent = nil;
      ...
      if ($eqeq(self.html_type, "style")) {
        ...
        $send(html_parent.$class_names(), 'each', [], function $$18(class_name){var class_to_remove = nil;
          if ($gvars.document == null) $gvars.document = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["id"], function $$19(value, atome, proc){
    ...
    if (proc == null) proc = nil;;
    return nil;}, 3);
  $send($$('Genesis'), 'generate_html_renderer', ["left"], function $$20(value, atome, proc){var $a, self = $$20.$$s == null ? this : $$20.$$s;
    if (self.html_type == null) self.html_type = nil;
    if (self.html_object == null) self.html_object = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["right"], function $$21(value, atome, proc){var $a, self = $$21.$$s == null ? this : $$21.$$s;
    if (self.html_type == null) self.html_type = nil;
    if (self.html_object == null) self.html_object = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["top"], function $$22(value, atome, proc){var $a, self = $$22.$$s == null ? this : $$22.$$s;
    if (self.html_type == null) self.html_type = nil;
    if (self.html_object == null) self.html_object = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["bottom"], function $$23(value, atome, proc){var $a, self = $$23.$$s == null ? this : $$23.$$s;
    if (self.html_type == null) self.html_type = nil;
    if (self.html_object == null) self.html_object = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["width"], function $$24(value, atome, proc){var $a, self = $$24.$$s == null ? this : $$24.$$s;
    if (self.html_type == null) self.html_type = nil;
    if (self.html_object == null) self.html_object = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["height"], function $$25(value, atome, proc){var $a, self = $$25.$$s == null ? this : $$25.$$s;
    if (self.html_type == null) self.html_type = nil;
    if (self.html_object == null) self.html_object = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["rotate"], function $$26(value, atome, proc){var $a, self = $$26.$$s == null ? this : $$26.$$s;
    if (self.html_type == null) self.html_type = nil;
    if (self.html_object == null) self.html_object = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["smooth"], function $$27(value, atome, proc){var $a, self = $$27.$$s == null ? this : $$27.$$s, formated_params = nil, $ret_or_1 = nil, properties = nil;
    if (self.html_type == null) self.html_type = nil;
    if (self.html_object == null) self.html_object = nil;
    ...
    if (proc == null) proc = nil;;
    formated_params = ($eqeqeq($$('Array'), ($ret_or_1 = value)) ? (((properties = []), $send(value, 'each', [], function $$28(param){
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["touch"], function $$29(value, atome, proc){var self = $$29.$$s == null ? this : $$29.$$s;
    if (self.html_object == null) self.html_object = nil;
    ...
    if (proc == null) proc = nil;;
    return $send(self.html_object, 'on', ["click"], function $$30(e){var self = $$30.$$s == null ? this : $$30.$$s;
  ...
  $send($$('Genesis'), 'generate_headless_renderer', ["drag"], function $$31(value, atome, user_proc){var self = $$31.$$s == null ? this : $$31.$$s;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["drag"], function $$32(value, atome, user_proc){var self = $$32.$$s == null ? this : $$32.$$s;
    if (self.html_object == null) self.html_object = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["overflow"], function $$33(value, atome, proc){var $a, self = $$33.$$s == null ? this : $$33.$$s;
    if (self.html_type == null) self.html_type = nil;
    if (self.html_object == null) self.html_object = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["image"], function $$34(value, atome, proc){var self = $$34.$$s == null ? this : $$34.$$s, id_found = nil;
    if ($gvars.document == null) $gvars.document = nil;
    ...
    $send(self, 'DOM', [], function $$35(){var self = $$35.$$s == null ? this : $$35.$$s;
  ...
  $send($$('Genesis'), 'atome_creator', ["text"], function $$36(params){var self = $$36.$$s == null ? this : $$36.$$s, default_renderer = nil, generated_id = nil, $ret_or_1 = nil, generated_render = nil, generated_parent = nil, default_params = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["visual"], function $$37(value, atome, proc){var $a, self = $$37.$$s == null ? this : $$37.$$s;
    if (self.html_object == null) self.html_object = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["text"], function $$38(value, atome, proc){var self = $$38.$$s == null ? this : $$38.$$s, id_found = nil;
    if ($gvars.document == null) $gvars.document = nil;
    ...
    $send(self, 'DOM', [], function $$39(){var self = $$39.$$s == null ? this : $$39.$$s;

      return self.$div($hash2(["id"], {"id": id_found})).$atome()}, {$$arity: 0, $$s: self}).$append_to($gvars.document['$[]']("user_view"));
    self.html_object = $gvars.document['$[]'](id_found);
    return (self.html_type = "text");}, {$$arity: 3, $$s: self});
  $$('Genesis').$atome_creator("video");
  $send($$('Genesis'), 'generate_html_renderer', ["video"], function $$40(value, atome, proc){var self = $$40.$$s == null ? this : $$40.$$s, id_found = nil;
    if ($gvars.document == null) $gvars.document = nil;
    ...
    $send(self, 'DOM', [], function $$41(){var self = $$41.$$s == null ? this : $$41.$$s;
  ...
  $send($$('Genesis'), 'atome_creator_option', ["particles_getter_pre_proc"], function $$42(params){var atome_found = nil, particles_hash = nil;
    ...
    $send(atome_found.$instance_variables(), 'each', [], function $$43(particle_found){var $a, particle_content = nil;
  ...
  $send($$('Genesis'), 'atome_creator_option', ["link_pre_render_proc"], function $$44(params){var self = $$44.$$s == null ? this : $$44.$$s, atome_found = nil, atome_to_link = nil, particles_found = nil, atome_type = nil, sanitized_particles = nil;
    ...
    $send(particles_found, 'each', [], function $$45(particle_name, value){var $a;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["path"], function $$46(value, atome, proc){var $a, self = $$46.$$s == null ? this : $$46.$$s;
    if (self.html_object == null) self.html_object = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["web"], function $$47(value, atome, proc){var self = $$47.$$s == null ? this : $$47.$$s, id_found = nil;
    if (self.html_object == null) self.html_object = nil;
    if ($gvars.document == null) $gvars.document = nil;
    ...
    $send(self, 'DOM', [], function $$48(){var self = $$48.$$s == null ? this : $$48.$$s;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["data"], function $$49(value, atome, proc){var self = $$49.$$s == null ? this : $$49.$$s;
  ...
  $send($$('Genesis'), 'atome_creator_option', ["code_pre_render_proc"], function $$50(params){var self = $$50.$$s == null ? this : $$50.$$s, str = nil;
    ...
    $def(self, '$get_binding', function $$get_binding() {
      ...
      return Opal.Binding.$new(  function($code) {    return eval($code);  },  [],  self,  ['atome/kernel/generators/generator.rb', 450])
    }, 0);
    str = params['$[]']("value");
    self.$eval(str, self.$get_binding(), "atome/kernel/generators/generator.rb", 453);
    return params['$[]']("value");}, {$$arity: 1, $$s: self});
  $$('Genesis').$particle_creator("on");
  return $send($$('Genesis'), 'generate_html_renderer', ["on"], function $$51(value, atome, proc){var self = $$51.$$s == null ? this : $$51.$$s;
    if (self.html_object == null) self.html_object = nil;
    ...
    if (proc == null) proc = nil;;
    return $send(self.html_object, 'on', [value], function $$52(e){var self = $$52.$$s == null ? this : $$52.$$s;
