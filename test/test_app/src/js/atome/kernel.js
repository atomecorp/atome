...
Opal.modules["atome/version"] = function(Opal) {/* Generated by Opal 1.7.3 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    return $const_set($nesting[0], 'VERSION', "0.5.4.0.7")
...
Opal.modules["atome/genesis/generators/utility"] = function(Opal) {/* Generated by Opal 1.7.3 */
  ...
  $send(self, 'new', [$hash2(["particle", "render"], {"particle": "delete", "render": false})], function $$2(params){var user_proc = $$2.$$p || nil, self = $$2.$$s == null ? this : $$2.$$s, id_found = nil, parents_found = nil;
    if (self.atome == null) self.atome = nil;
    ...
    if ($eqeq(params, true)) {
      ...
      return $send(params, 'each', [], function $$8(param, value){var $a, self = $$8.$$s == null ? this : $$8.$$s;
  ...
  $send(self, 'new', [$hash2(["post"], {"post": "clear"})], function $$9(){var self = $$9.$$s == null ? this : $$9.$$s, attached_found = nil;
    if (self.atome == null) self.atome = nil;

    
    attached_found = [];
    $send(self.atome['$[]']("attached"), 'each', [], function $$10(attached_id_found){
      
      if (attached_id_found == null) attached_id_found = nil;
      return attached_found['$<<'](attached_id_found);});
    return $send(attached_found, 'each', [], function $$11(child_id_found){var self = $$11.$$s == null ? this : $$11.$$s, child_found = nil;
  ...
  $send(self, 'new', [$hash2(["particle"], {"particle": "schedule"})], function $$12(date, proc){var self = $$12.$$s == null ? this : $$12.$$s, delimiters = nil, format_date = nil;
    ...
    return $send($$('Universe').$renderer_list(), 'each', [], function $$13(renderer){var self = $$13.$$s == null ? this : $$13.$$s;

      
      if (renderer == null) renderer = nil;
      return $send(self, 'send', ["" + (renderer) + "_schedule", format_date], proc.$to_proc());}, {$$s: self});}, {$$s: self});
  $send(self, 'new', [$hash2(["particle"], {"particle": "read"})], function $$14(file, proc){var self = $$14.$$s == null ? this : $$14.$$s;

    
    if (file == null) file = nil;
    if (proc == null) proc = nil;
    return $send($$('Universe').$renderer_list(), 'each', [], function $$15(renderer){var self = $$15.$$s == null ? this : $$15.$$s;
  ...
  return $send(self, 'new', [$hash2(["sanitizer"], {"sanitizer": "batch"})], function $$16(params){
