Opal.queue(function(Opal) {/* Generated by Opal 1.5.1 */
  var self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, $hash2 = Opal.hash2, $send = Opal.send, $truthy = Opal.truthy, $def = Opal.def, $eqeq = Opal.eqeq, b = nil, c = nil, a = nil;

  Opal.add_stubs('box,height,left,smooth,touch,color,length,atomes,top,rotate,alert,is_a?,instance_exec,to_proc,particle_creator,generate_headless_renderer,puts,class,generate_html_renderer,==,remove_class,add_class,new,drag,shape,circle');
  ...
  $def(self, '$dragCallback', function $$dragCallback(page_x, page_y, current_obj, proc) {
    var self = this;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["drag"], function $$4(value, atome, user_proc){var self = $$4.$$s == null ? this : $$4.$$s;
    ...
    return (self.html_drag = user_proc);}, {$$arity: 3, $$s: self});
  ...
  $send(a.$shape(), 'drag', [true], function $$5(x, y){var self = $$5.$$s == null ? this : $$5.$$s;
    ...
    if (y == null) y = nil;;
    return self.$puts("ok on passe ici : " + (x));}, {$$arity: 2, $$s: self});
