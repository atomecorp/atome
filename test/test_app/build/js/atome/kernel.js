...
Opal.modules["atome/version"] = function(Opal) {/* Generated by Opal 1.5.1 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    return $const_set($nesting[0], 'VERSION', "0.451")
...
Opal.modules["atome/extensions/helper"] = function(Opal) {/* Generated by Opal 1.5.1 */
  ...
  Opal.add_stubs('grab,send,to_f,*,is_a?,instance_exec,to_proc,to_s,split,union,now,length,[]');
  ...
  $def(self, '$read_ruby', function $$read_ruby(file) {
...
fetch('medias/rubies/'+file)
  ...
  $def(self, '$read_text', function $$read_text(file) {
...
fetch('medias/rubies/'+file)
  ...
  $def(self, '$read', function $$read(file, action) {
    ...
    return self.$send("read_" + (action), file);
  }, -2);
