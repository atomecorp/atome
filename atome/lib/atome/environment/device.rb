class Device
  ...
  def initialize
    ...
    Atome.new({ atome_id: :view, type: :particle, width: "100%", height: "100%", x: 0, y: 0, z: 0, overflow: :auto, parent: :intuition, color: { red: 0, green: 0, blue: 0, alpha: 0 }, tactile: ATOME.mobile? })
