...
#
#
#   interact('#'+#{atome_id}).on('hold', function (event) {
# alert('ok');
...
my_video = Atome.new(
  video: { renderers: [:browser],  id: :video1, type: :video, parents: [:view],
           path: './medias/videos/madmax.mp4', left: 333, top: 33, width: 777
  }
) do |params|
...
# a=AtomeJS.new
# AtomeJS.check_this(:kool)
# class AtomeHTML
#   def self.atomeJS(method, params)
#     methods= `Object.keys(atomeJS)`
#
#     a="atomeJS.verif(#{params})"
#     a.to_n
#     # `atomeJS.verif(#{params})`
#   end
# end
# AtomeHTML.atomeJS(:verif, :super)
