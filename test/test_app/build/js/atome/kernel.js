...
Opal.modules["atome/version"] = function(Opal) {/* Generated by Opal 1.5.1 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    return $const_set($nesting[0], 'VERSION', "0.448")
  ...
  return (function($base, $parent_nesting) {
    ...
    $defs(self, '$optional_atome_methods', function $$optional_atome_methods(method_name) {
      ...
      $send($$('Genesis'), 'atome_creator_option', [(("" + (method_name)) + "_pre_save_proc").$to_sym()], function $$8(params, proc){
        ...
        return params;}, 2);
      return $send($$('Genesis'), 'atome_creator_option', [(("" + (method_name)) + "_sanitizer_proc").$to_sym()], function $$9(params, atome, proc){
    ...
    $defs(self, '$additional_atome_methods', function $$additional_atome_methods(method_name) {
      ...
      $send($$('Atome'), 'define_method', ["" + (method_name) + "s"], function $$10(params){var self = $$10.$$s == null ? this : $$10.$$s;

        
        
        if (params == null) params = nil;;
        return self.$additional_atomes(method_name, params);}, {$$arity: -1, $$s: self});
      $send($$('Atome'), 'define_method', ["set_" + (method_name)], function $$11(params){var proc = $$11.$$p || nil, self = $$11.$$s == null ? this : $$11.$$s;
      ...
      $send($$('Atome'), 'define_method', ["get_" + (method_name)], function $$12(){var self = $$12.$$s == null ? this : $$12.$$s;
    ...
    $defs(self, '$optional_particle_methods', function $$optional_particle_methods(method_name) {
      ...
      $send($$('Genesis'), 'atome_creator_option', [(("" + (method_name)) + "_render_proc").$to_sym()], function $$15(params){
        
        
        if (params == null) params = nil;;
        $send(params['$[]']("atome"), 'render_engine', [params['$[]']("method"), params['$[]']("value"), params['$[]']("atome")], params['$[]']("proc").$to_proc());
        return params['$[]']("value");}, 1);
      $send($$('Genesis'), 'atome_creator_option', [(("" + (method_name)) + "_pre_render_proc").$to_sym()], function $$16(params){var particle_instance_variable = nil;
        ...
        return params['$[]']("value");}, 1);
      return $send($$('Genesis'), 'atome_creator_option', [(("" + (method_name)) + "_post_render_proc").$to_sym()], function $$17(params){
    ...
    $defs(self, '$additional_particle_methods', function $$additional_particle_methods(method_name) {
      ...
      $send($$('Atome'), 'define_method', ["set_" + (method_name)], function $$18(params){var proc = $$18.$$p || nil, self = $$18.$$s == null ? this : $$18.$$s;
      ...
      $send($$('Atome'), 'define_method', ["get_" + (method_name)], function $$19(){var self = $$19.$$s == null ? this : $$19.$$s;
...
Opal.modules["atome/kernel/generators/generator"] = function(Opal) {/* Generated by Opal 1.5.1 */
  ...
  Opal.add_stubs('atome_creator,atome_creator_option,instance_of?,==,downcase,each_with_index,split,gsub,[]=,[],keys,/,to_i,css_rgb,merge,id,particle_creator,generate_html_renderer,puts,send,is_a?,instance_exec,to_proc,append_to,DOM,atome,div,<<,head,green,blue,alpha,inner_html=,*,red,add_class,style,method_name,===,each,to_s,join,on,instance_variable_set,generate_headless_renderer,class,remove_class');
...
;
  ...
  $send($$('Genesis'), 'atome_creator_option', ["type_pre_render_proc"], function $$4(params){
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["drm"], function $$13(value, atome, proc){
    ...
    if (proc == null) proc = nil;;
    return nil;}, 3);
  $send($$('Genesis'), 'generate_html_renderer', ["parent"], function $$14(value, atome, proc){var self = $$14.$$s == null ? this : $$14.$$s;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["id"], function $$15(value, atome, proc){
    ...
    if (proc == null) proc = nil;;
    return nil;}, 3);
  $send($$('Genesis'), 'generate_html_renderer', ["left"], function $$16(value, atome, proc){var $a, self = $$16.$$s == null ? this : $$16.$$s;
    if (self.html_type == null) self.html_type = nil;
    if (self.html_object == null) self.html_object = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["right"], function $$17(value, atome, proc){var $a, self = $$17.$$s == null ? this : $$17.$$s;
    if (self.html_type == null) self.html_type = nil;
    if (self.html_object == null) self.html_object = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["top"], function $$18(value, atome, proc){var $a, self = $$18.$$s == null ? this : $$18.$$s;
    if (self.html_type == null) self.html_type = nil;
    if (self.html_object == null) self.html_object = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["bottom"], function $$19(value, atome, proc){var $a, self = $$19.$$s == null ? this : $$19.$$s;
    if (self.html_type == null) self.html_type = nil;
    if (self.html_object == null) self.html_object = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["width"], function $$20(value, atome, proc){var $a, self = $$20.$$s == null ? this : $$20.$$s;
    if (self.html_object == null) self.html_object = nil;
    if (self.html_type == null) self.html_type = nil;
    ...
    if (proc == null) proc = nil;;
    self.html_object['$[]=']("width", "" + (value) + "px");
    if ($eqeq(self.html_type, "style")) {
      return nil
    } else {
      return ($a = ["width", "" + (value) + "px"], $send(self.html_object.$style(), '[]=', $a), $a[$a.length - 1])
    };}, {$$arity: 3, $$s: self});
  $send($$('Genesis'), 'generate_html_renderer', ["height"], function $$21(value, atome, proc){var $a, self = $$21.$$s == null ? this : $$21.$$s;
    if (self.html_object == null) self.html_object = nil;
    if (self.html_type == null) self.html_type = nil;
    ...
    if (proc == null) proc = nil;;
    self.html_object['$[]=']("height", "" + (value) + "px");
    if ($eqeq(self.html_type, "style")) {
      return nil
    } else {
      return ($a = ["height", "" + (value) + "px"], $send(self.html_object.$style(), '[]=', $a), $a[$a.length - 1])
    };}, {$$arity: 3, $$s: self});
  $send($$('Genesis'), 'particle_creator', ["rotate"], function $$22(params, atome){var proc = $$22.$$p || nil, self = $$22.$$s == null ? this : $$22.$$s;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["rotate"], function $$24(value, atome, proc){var $a, self = $$24.$$s == null ? this : $$24.$$s;
    if (self.html_type == null) self.html_type = nil;
    if (self.html_object == null) self.html_object = nil;
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["smooth"], function $$25(value, atome, proc){var $a, self = $$25.$$s == null ? this : $$25.$$s, formated_params = nil, $ret_or_1 = nil, properties = nil;
    if (self.html_type == null) self.html_type = nil;
    if (self.html_object == null) self.html_object = nil;
    ...
    if (proc == null) proc = nil;;
    formated_params = ($eqeqeq($$('Array'), ($ret_or_1 = value)) ? (((properties = []), $send(value, 'each', [], function $$26(param){
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["touch"], function $$27(value, atome, proc){var self = $$27.$$s == null ? this : $$27.$$s;
    if (self.html_object == null) self.html_object = nil;
    ...
    if (proc == null) proc = nil;;
    return $send(self.html_object, 'on', ["click"], function $$28(e){var self = $$28.$$s == null ? this : $$28.$$s;
  ...
  $send($$('Genesis'), 'generate_headless_renderer', ["drag"], function $$29(value, atome, user_proc){var self = $$29.$$s == null ? this : $$29.$$s;
  ...
  return $send($$('Genesis'), 'generate_html_renderer', ["drag"], function $$30(value, atome, user_proc){var self = $$30.$$s == null ? this : $$30.$$s;
    if (self.html_object == null) self.html_object = nil;
...
Opal.modules["atome/kernel/sparkle"] = function(Opal) {/* Generated by Opal 1.5.1 */
  ...
  $$('Atome').$new($hash2(["shape"], {"shape": $hash2(["render", "id", "type", "parent", "left", "right", "top", "bottom", "color"], {"render": [default_render], "id": "view", "type": "shape", "parent": "user_view", "left": 0, "right": 0, "top": 0, "bottom": 0, "color": $hash2(["render", "id", "type", "red", "green", "blue", "alpha"], {"render": [default_render], "id": "c1", "type": "color", "red": 0.15, "green": 0.15, "blue": 0.15, "alpha": 1})})}));
