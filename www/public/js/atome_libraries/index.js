...
//
//
// $("#view").append("<canvas id='fab_c' width="+elemClientWidth+" height= "+elemClientHeight+"></canvas>");
//
//
//     window.addEventListener('resize', reportWindowSize);
//     // create a wrapper around native canvas element (with id="c")
//     var canvas = new fabric.Canvas('fab_c');
//
...
//         duration: 3000
//     });
//     // var image = new fabric.Image(document.getElementById('fab_c'), {
//     //     width: 100,
//     //     height: 100,
//     //     left: 50,
//     //     top: 50
...
//     // canvas.add(image);
//
//     // fabric.Image(document.getElementById('view'),  function(img){
//     //     // img.set({left: 133});
//     //     // // add filter
//     //     // img.filters.push(new fabric.Image.filters.Sepia());
//     //     //
