...
Opal.modules["atome/kernel/generators/generator"] = function(Opal) {/* Generated by Opal 1.5.1 */
  ...
  Opal.add_stubs('atome_creator,atome_creator_option,instance_of?,==,downcase,each_with_index,split,gsub,[]=,[],keys,/,to_i,css_rgb,merge,id,particle_creator,generate_html_renderer,send,is_a?,instance_exec,to_proc,append_to,DOM,atome,div,<<,head,type,green,blue,alpha,inner_html=,*,red,each,instance_variable_get,grab,class_names,attributes,remove_class,add_class,style,method_name,===,to_s,join,on,instance_variable_set,generate_headless_renderer,puts,class,img,text=,video,instance_variables,particles,delete');
...
;
  ...
  return $$('Genesis').$particle_creator("html_object");
};
