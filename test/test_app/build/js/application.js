Opal.queue(function(Opal) {/* Generated by Opal 1.5.1 */
  var self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, $hash2 = Opal.hash2, $send = Opal.send, $eqeq = Opal.eqeq, $rb_plus = Opal.rb_plus, $truthy = Opal.truthy, $gvars = Opal.gvars, b = nil, c = nil, a = nil, image = nil, text = nil, video = nil;

  Opal.add_stubs('box,height,left,smooth,touch,color,length,atomes,top,rotate,alert,new,drag,shape,puts,==,circle,atome_creator,particle_creator,generate_html_renderer,[]=,+,to_s,now,style,id,is_a?,instance_exec,to_proc,append_to,DOM,atome,image,[],text=,div,video');
...
img.src = value;
;
    self.html_object['$[]=']("src", $rb_plus($rb_plus(value, "?"), $$('Time').$now().$to_s()));
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["image"], function $$6(value, atome, proc){var self = $$6.$$s == null ? this : $$6.$$s, id_found = nil;
    ...
    $send(self, 'DOM', [], function $$7(){var self = $$7.$$s == null ? this : $$7.$$s;
      ...
      return self.$image($hash2(["id"], {"id": id_found})).$atome()}, {$$arity: 0, $$s: self}).$append_to($gvars.document['$[]']("user_view"));
    self.html_object = $gvars.document['$[]'](id_found);
    return (self.html_type = "image");}, {$$arity: 3, $$s: self});
  image = $$('Atome').$new($hash2(["image"], {"image": $hash2(["render", "id", "type", "parent", "path", "left", "top", "width", "height", "color"], {"render": ["html"], "id": "image_12", "type": "image", "parent": "view", "path": "./medias/images/boat.png", "left": 99, "top": 120, "width": 99, "height": 199, "color": $hash2(["render", "id", "type", "red", "green", "blue", "alpha"], {"render": ["html"], "id": "c315", "type": "color", "red": 0, "green": 1, "blue": 0, "alpha": 0.6})})}));
  ...
  text = $$('Atome').$new($hash2(["image"], {"image": $hash2(["render", "id", "type", "parent", "visual", "string", "left", "top", "width", "height"], {"render": ["html"], "id": "text1", "type": "text", "parent": "view", "visual": $hash2(["size"], {"size": 33}), "string": "hello!", "left": 99, "top": 333, "width": 199, "height": 99})}));
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["video"], function $$12(value, atome, proc){var self = $$12.$$s == null ? this : $$12.$$s, id_found = nil;
    ...
    $send(self, 'DOM', [], function $$13(){var self = $$13.$$s == null ? this : $$13.$$s;
      ...
      return self.$video($hash2(["id"], {"id": id_found})).$atome()}, {$$arity: 0, $$s: self}).$append_to($gvars.document['$[]']("user_view"));
    self.html_object = $gvars.document['$[]'](id_found);
    return (self.html_type = "video");}, {$$arity: 3, $$s: self});
  video = $$('Atome').$new($hash2(["image"], {"image": $hash2(["render", "id", "type", "parent", "path", "left", "top", "width", "height"], {"render": ["html"], "id": "video1", "type": "video", "parent": "view", "path": "./medias/videos/avengers.mp4", "left": 333, "top": 333, "width": 199, "height": 99})}));
  return $$('Genesis').$atome_creator("animator");
});
