module DefaultValues
  def default_values
    ...
    tool = visual.merge({type: :tool, width: 33, height: 33, color: { red: 1, green: 0, blue: 1, alpha: 0.9 }, smooth: 3, parent: :intuition, content: [], overflow: :visible, status: { open: false, active: false, orientation: :top, detail: false } })
