...
`)}},!function A(g,I,B){"rb-js-abi-host"in g||(g["rb-js-abi-host"]={}),g["rb-js-abi-host"]["eval-js: func(code: string) -> variant { success(handle<js-abi-value>), failure(handle<js-abi-value>) }"]=function(A,g,C){let E=B("memory"),i=Ae.decode(new Uint8Array(E.buffer,A,g)),D=I.evalJs(i),o=D;switch(o.tag){case"success":{let w=o.val;AL(E).setInt8(C+0,0,!0),AL(E).setInt32(C+4,Q.insert(w),!0);break}case"failure":{let G=o.val;AL(E).setInt8(C+0,1,!0),AL(E).setInt32(C+4,Q.insert(G),!0);break}default:throw RangeError("invalid variant specified for JsAbiResult")}},g["rb-js-abi-host"]["is-js: func(value: handle<js-abi-value>) -> bool"]=function(A){let g=I.isJs(Q.get(A));return g?1:0},g["rb-js-abi-host"]["instance-of: func(value: handle<js-abi-value>, klass: handle<js-abi-value>) -> bool"]=function(A,g){let B=I.instanceOf(Q.get(A),Q.get(g));return B?1:0},g["rb-js-abi-host"]["global-this: func() -> handle<js-abi-value>"]=function(){let A=I.globalThis();return Q.insert(A)},g["rb-js-abi-host"]["int-to-js-number: func(value: s32) -> handle<js-abi-value>"]=function(A){let g=I.intToJsNumber(A);return Q.insert(g)},g["rb-js-abi-host"]["float-to-js-number: func(value: float64) -> handle<js-abi-value>"]=function(A){let g=I.floatToJsNumber(A);return Q.insert(g)},g["rb-js-abi-host"]["string-to-js-string: func(value: string) -> handle<js-abi-value>"]=function(A,g){let C=B("memory"),E=Ae.decode(new Uint8Array(C.buffer,A,g)),i=I.stringToJsString(E);return Q.insert(i)},g["rb-js-abi-host"]["bool-to-js-bool: func(value: bool) -> handle<js-abi-value>"]=function(A){let g=A,B=I.boolToJsBool(0!=g&&(1==g||A0()));return Q.insert(B)},g["rb-js-abi-host"]["proc-to-js-function: func(value: u32) -> handle<js-abi-value>"]=function(A){let g=I.procToJsFunction(A>>>0);return Q.insert(g)},g["rb-js-abi-host"]["rb-object-to-js-rb-value: func(raw-rb-abi-value: u32) -> handle<js-abi-value>"]=function(A){let g=I.rbObjectToJsRbValue(A>>>0);return Q.insert(g)},g["rb-js-abi-host"]["js-value-to-string: func(value: handle<js-abi-value>) -> string"]=function(A,g){let C=B("memory"),E=B("cabi_realloc"),i=I.jsValueToString(Q.get(A)),D=An(i,E,C),o=Ar;AL(C).setInt32(g+4,o,!0),AL(C).setInt32(g+0,D,!0)},g["rb-js-abi-host"]["js-value-to-integer: func(value: handle<js-abi-value>) -> variant { f64(float64), bignum(string) }"]=function(A,g){let C=B("memory"),E=B("cabi_realloc"),i=I.jsValueToInteger(Q.get(A)),D=i;switch(D.tag){case"f64":{let o=D.val;AL(C).setInt8(g+0,0,!0),AL(C).setFloat64(g+8,+o,!0);break}case"bignum":{let w=D.val;AL(C).setInt8(g+0,1,!0);let G=An(w,E,C),a=Ar;AL(C).setInt32(g+12,a,!0),AL(C).setInt32(g+8,G,!0);break}default:throw RangeError("invalid variant specified for RawInteger")}},g["rb-js-abi-host"]["export-js-value-to-host: func(value: handle<js-abi-value>) -> ()"]=function(A){I.exportJsValueToHost(Q.get(A))},g["rb-js-abi-host"]["import-js-value-from-host: func() -> handle<js-abi-value>"]=function(){let A=I.importJsValueFromHost();return Q.insert(A)},g["rb-js-abi-host"]["js-value-typeof: func(value: handle<js-abi-value>) -> string"]=function(A,g){let C=B("memory"),E=B("cabi_realloc"),i=I.jsValueTypeof(Q.get(A)),D=An(i,E,C),o=Ar;AL(C).setInt32(g+4,o,!0),AL(C).setInt32(g+0,D,!0)},g["rb-js-abi-host"]["js-value-equal: func(lhs: handle<js-abi-value>, rhs: handle<js-abi-value>) -> bool"]=function(A,g){let B=I.jsValueEqual(Q.get(A),Q.get(g));return B?1:0},g["rb-js-abi-host"]["js-value-strictly-equal: func(lhs: handle<js-abi-value>, rhs: handle<js-abi-value>) -> bool"]=function(A,g){let B=I.jsValueStrictlyEqual(Q.get(A),Q.get(g));return B?1:0},g["rb-js-abi-host"]["reflect-apply: func(target: handle<js-abi-value>, this-argument: handle<js-abi-value>, arguments: list<handle<js-abi-value>>) -> variant { success(handle<js-abi-value>), failure(handle<js-abi-value>) }"]=function(A,g,C,E,i){let D=B("memory"),o=E,w=C,G=[];for(let a=0;a<o;a++){let h=w+4*a;G.push(Q.get(AL(D).getInt32(h+0,!0)))}let N=I.reflectApply(Q.get(A),Q.get(g),G),y=N;switch(y.tag){case"success":{let k=y.val;AL(D).setInt8(i+0,0,!0),AL(D).setInt32(i+4,Q.insert(k),!0);break}case"failure":{let M=y.val;AL(D).setInt8(i+0,1,!0),AL(D).setInt32(i+4,Q.insert(M),!0);break}default:throw RangeError("invalid variant specified for JsAbiResult")}},g["rb-js-abi-host"]["reflect-construct: func(target: handle<js-abi-value>, arguments: list<handle<js-abi-value>>) -> handle<js-abi-value>"]=function(A,g,C){let E=B("memory"),i=C,D=g,o=[];for(let w=0;w<i;w++){let G=D+4*w;o.push(Q.get(AL(E).getInt32(G+0,!0)))}let a=I.reflectConstruct(Q.get(A),o);return Q.insert(a)},g["rb-js-abi-host"]["reflect-delete-property: func(target: handle<js-abi-value>, property-key: string) -> bool"]=function(A,g,C){let E=B("memory"),i=Ae.decode(new Uint8Array(E.buffer,g,C)),D=I.reflectDeleteProperty(Q.get(A),i);return D?1:0},g["rb-js-abi-host"]["reflect-get: func(target: handle<js-abi-value>, property-key: string) -> variant { success(handle<js-abi-value>), failure(handle<js-abi-value>) }"]=function(A,g,C,E){let i=B("memory"),D=Ae.decode(new Uint8Array(i.buffer,g,C)),o=I.reflectGet(Q.get(A),D),w=o;switch(w.tag){case"success":{let G=w.val;AL(i).setInt8(E+0,0,!0),AL(i).setInt32(E+4,Q.insert(G),!0);break}case"failure":{let a=w.val;AL(i).setInt8(E+0,1,!0),AL(i).setInt32(E+4,Q.insert(a),!0);break}default:throw RangeError("invalid variant specified for JsAbiResult")}},g["rb-js-abi-host"]["reflect-get-own-property-descriptor: func(target: handle<js-abi-value>, property-key: string) -> handle<js-abi-value>"]=function(A,g,C){let E=B("memory"),i=Ae.decode(new Uint8Array(E.buffer,g,C)),D=I.reflectGetOwnPropertyDescriptor(Q.get(A),i);return Q.insert(D)},g["rb-js-abi-host"]["reflect-get-prototype-of: func(target: handle<js-abi-value>) -> handle<js-abi-value>"]=function(A){let g=I.reflectGetPrototypeOf(Q.get(A));return Q.insert(g)},g["rb-js-abi-host"]["reflect-has: func(target: handle<js-abi-value>, property-key: string) -> bool"]=function(A,g,C){let E=B("memory"),i=Ae.decode(new Uint8Array(E.buffer,g,C)),D=I.reflectHas(Q.get(A),i);return D?1:0},g["rb-js-abi-host"]["reflect-is-extensible: func(target: handle<js-abi-value>) -> bool"]=function(A){let g=I.reflectIsExtensible(Q.get(A));return g?1:0},g["rb-js-abi-host"]["reflect-own-keys: func(target: handle<js-abi-value>) -> list<handle<js-abi-value>>"]=function(A,g){let C=B("memory"),E=B("cabi_realloc"),i=I.reflectOwnKeys(Q.get(A)),D=i,o=D.length,w=E(0,0,4,4*o);for(let G=0;G<D.length;G++){let a=D[G],h=w+4*G;AL(C).setInt32(h+0,Q.insert(a),!0)}AL(C).setInt32(g+4,o,!0),AL(C).setInt32(g+0,w,!0)},g["rb-js-abi-host"]["reflect-prevent-extensions: func(target: handle<js-abi-value>) -> bool"]=function(A){let g=I.reflectPreventExtensions(Q.get(A));return g?1:0},g["rb-js-abi-host"]["reflect-set: func(target: handle<js-abi-value>, property-key: string, value: handle<js-abi-value>) -> variant { success(handle<js-abi-value>), failure(handle<js-abi-value>) }"]=function(A,g,C,E,i){let D=B("memory"),o=Ae.decode(new Uint8Array(D.buffer,g,C)),w=I.reflectSet(Q.get(A),o,Q.get(E)),G=w;switch(G.tag){case"success":{let a=G.val;AL(D).setInt8(i+0,0,!0),AL(D).setInt32(i+4,Q.insert(a),!0);break}case"failure":{let h=G.val;AL(D).setInt8(i+0,1,!0),AL(D).setInt32(i+4,Q.insert(h),!0);break}default:throw RangeError("invalid variant specified for JsAbiResult")}},g["rb-js-abi-host"]["reflect-set-prototype-of: func(target: handle<js-abi-value>, prototype: handle<js-abi-value>) -> bool"]=function(A,g){let B=I.reflectSetPrototypeOf(Q.get(A),Q.get(g));return B?1:0},"canonical_abi"in g||(g.canonical_abi={});let Q=new Aq;g.canonical_abi["resource_drop_js-abi-value"]=A=>{let g=Q.remove(A);I.dropJsAbiValue&&I.dropJsAbiValue(g)}}(A,(A=>{for(let[g,I]of Object.entries(A))"function"==typeof I&&(A[g]=(...g)=>{let B=this.interfaceState.hasJSFrameAfterRbFrame;this.interfaceState.hasJSFrameAfterRbFrame=!0;let Q=Reflect.apply(I,A,g);return this.interfaceState.hasJSFrameAfterRbFrame=B,Q});return A})({evalJs:g(A=>Function(A)()),isJs:A=>!0,globalThis(){if("undefined"!=typeof globalThis)return globalThis;if("undefined"!=typeof global)return global;if("undefined"!=typeof window)return window;throw Error("unable to locate global object")},intToJsNumber:A=>A,floatToJsNumber:A=>A,stringToJsString:A=>A,boolToJsBool:A=>A,procToJsFunction:A=>{let g=this.rbValueOfPointer(A);return(...A)=>{g.call("call",...A.map(A=>this.wrap(A)))}},rbObjectToJsRbValue:A=>this.rbValueOfPointer(A),jsValueToString:A=>String(A),jsValueToInteger:A=>"number"==typeof A?{tag:"f64",val:A}:"bigint"==typeof A?{tag:"bignum",val:BigInt(A).toString(10)+"\0"}:"string"==typeof A?{tag:"bignum",val:A+"\0"}:void 0===A?{tag:"f64",val:0}:{tag:"f64",val:Number(A)},exportJsValueToHost:A=>{this.transport.takeJsValue(A)},importJsValueFromHost:()=>this.transport.consumeJsValue(),instanceOf:(A,g)=>"function"==typeof g&&A instanceof g,jsValueTypeof:A=>typeof A,jsValueEqual:(A,g)=>A==g,jsValueStrictlyEqual:(A,g)=>A===g,reflectApply:g((A,g,I)=>Reflect.apply(A,g,I)),reflectConstruct:function(A,g){throw Error("Function not implemented.")},reflectDeleteProperty:function(A,g){throw Error("Function not implemented.")},reflectGet:g((A,g)=>A[g]),reflectGetOwnPropertyDescriptor:function(A,g){throw Error("Function not implemented.")},reflectGetPrototypeOf:function(A){throw Error("Function not implemented.")},reflectHas:function(A,g){throw Error("Function not implemented.")},reflectIsExtensible:function(A){throw Error("Function not implemented.")},reflectOwnKeys:function(A){throw Error("Function not implemented.")},reflectPreventExtensions:function(A){throw Error("Function not implemented.")},reflectSet:g((A,g,I)=>Reflect.set(A,g,I)),reflectSetPrototypeOf:function(A,g){throw Error("Function not implemented.")}}),A=>this.instance.exports[A])}printVersion(){this.guest.rubyShowVersion()}eval(A){return Ax(this,this.privateObject(),A)}evalAsync(A){let g=this.eval("require 'js'; JS");return new Promise((I,B)=>{g.call("__eval_async_rb",this.wrap(A),this.wrap({resolve:I,reject:A=>{B(new Aj(this.exceptionFormatter.format(A,this,this.privateObject())))}}))})}wrap(A){return this.transport.importJsValue(A,this)}privateObject(){return{transport:this.transport,exceptionFormatter:this.exceptionFormatter}}rbValueOfPointer(A){let g=new Ad(A,this.guest);return new AZ(g,this,this.privateObject())}}class Ap{constructor(){this._takenJsValue=null}takeJsValue(A){this._takenJsValue=A}consumeJsValue(){return this._takenJsValue}exportJsValue(A){return A.call("__export_to_js"),this._takenJsValue}importJsValue(A,g){return this._takenJsValue=A,g.eval('require "js"; JS::Object').call("__import_from_js")}}class AZ{constructor(A,g,I){this.inner=A,this.vm=g,this.privateObject=I}call(A,...g){let I=g.map(A=>A.inner);return new AZ(A6(this.vm,this.privateObject,this.inner,A,I),this.vm,this.privateObject)}[Symbol.toPrimitive](A){return"string"===A||"default"===A?this.toString():null}toString(){let A=A6(this.vm,this.privateObject,this.inner,"to_s",[]);return this.vm.guest.rstringPtr(A)}toJS(){let A=this.vm.eval("JS"),g=A.call("try_convert",this);return"true"===g.call("nil?").toString()?null:this.privateObject.transport.exportJsValue(g)}}(Av=A||(A={}))[Av.None=0]="None",Av[Av.Return=1]="Return",Av[Av.Break=2]="Break",Av[Av.Next=3]="Next",Av[Av.Retry=4]="Retry",Av[Av.Redo=5]="Redo",Av[Av.Raise=6]="Raise",Av[Av.Throw=7]="Throw",Av[Av.Fatal=8]="Fatal",Av[Av.Mask=15]="Mask";class Au{constructor(){this.literalsCache=null}format(A,g,I){let[B,Q,C]=(()=>{if(null!=this.literalsCache)return this.literalsCache;{let A=[Ax(g,I,"0"),Ax(g,I,"1"),Ax(g,I,`"
"`),];return this.literalsCache=A,A}})(),E=A.call("backtrace");if("true"===E.call("nil?").toString())return this.formatString(A.call("class").toString(),A.toString());let i=E.call("at",B),D=E.call("drop",Q).call("join",C);return this.formatString(A.call("class").toString(),A.toString(),[i.toString(),D.toString(),])}formatString(A,g,I){return I?`${I[0]}: ${g} (${A})
${I[1]}`:`${A}: ${g}`}}let A1=(g,I,B)=>{switch(g&A.Mask){case A.None:break;case A.Return:throw new Aj("unexpected return");case A.Next:throw new Aj("unexpected next");case A.Break:throw new Aj("unexpected break");case A.Redo:throw new Aj("unexpected redo");case A.Retry:throw new Aj("retry outside of rescue clause");case A.Throw:throw new Aj("unexpected throw");case A.Raise:case A.Fatal:let Q=new AZ(I.guest.rbErrinfo(),I,B);if("true"===Q.call("nil?").toString())throw new Aj("no exception object");throw I.guest.rbClearErrinfo(),new Aj(B.exceptionFormatter.format(Q,I,B));default:throw new Aj(`unknown error tag: ${g}`)}};function Am(A,g){try{return g()}catch(I){if(I instanceof Aj)throw I;if(A.guest.rbVmBugreport(),I instanceof WebAssembly.RuntimeError&&"unreachable"===I.message){let B=new Aj(`Something went wrong in Ruby VM: ${I}`);throw B.stack=I.stack,B}throw I}}let A6=(A,g,I,B,Q)=>{let C=A.guest.rbIntern(B+"\0");return Am(A,()=>{let[B,E]=A.guest.rbFuncallvProtect(I,C,Q);return A1(E,A,g),B})},Ax=(A,g,I)=>Am(A,()=>{let[B,Q]=A.guest.rbEvalStringProtect(I+"\0");return A1(Q,A,g),new AZ(B,A,g)});class Aj extends Error{constructor(A){super(A)}}class AW extends Aj{constructor(A){super("Ruby Fatal Error: "+A)}}let A2=()=>{let A,g,I=new TextDecoder;return{addToImports(B){let Q=B.wasi_snapshot_preview1.fd_write;B.wasi_snapshot_preview1.fd_write=(B,C,E,i)=>{if(1!==B&&2!==B)return Q(B,C,E,i);if(void 0===A||void 0===g)throw Error("Memory is not set");0===g.buffer.byteLength&&(g=new DataView(A.buffer));let D=Array.from({length:E},(I,B)=>{let Q=C+8*B,E=g.getUint32(Q,!0),i=g.getUint32(Q+4,!0);return new Uint8Array(A.buffer,E,i)}),o=0,w="";for(let G of D)w+=I.decode(G),o+=G.byteLength;g.setUint32(i,o,!0);let a=1===B?console.log:console.warn;return a(w),0}},setMemory(I){A=I,g=new DataView(I.buffer)}}},AV=async(A,g={consolePrint:!0})=>{await AU();let I=new AJ({}),B=new Ab,Q=I.getImports(A);B.addToImports(Q);let C=g.consolePrint?A2():void 0;null==C||C.addToImports(Q);let E=await WebAssembly.instantiate(A,Q);return I.instantiate(E),await B.setInstance(E),null==C||C.setMemory(E.exports.memory),E.exports._initialize(),B.initialize(),{vm:B,wasi:I,instance:E}},AT=async A=>{let g=await fetch("./wasm/ruby/ruby_browser.wasm"),I=await g.arrayBuffer(),B=await WebAssembly.compile(I),{vm:Q}=await AV(B);Q.printVersion(),globalThis.rubyVM=Q,"loading"===document.readyState?document.addEventListener("DOMContentLoaded",()=>AO(Q)):AO(Q)},AO=async A=>{var g,I,B,Q;let C=document.querySelectorAll('script[type="text/ruby"]'),E=Array.from(C).map(A=>Az(A));try{for(var i,D=!0,o=function A(g){if(!Symbol.asyncIterator)throw TypeError("Symbol.asyncIterator is not defined.");var I,B=g[Symbol.asyncIterator];return B?B.call(g):(g=function A(g){var I="function"==typeof Symbol&&Symbol.iterator,B=I&&g[I],Q=0;if(B)return B.call(g);if(g&&"number"==typeof g.length)return{next:function(){return g&&Q>=g.length&&(g=void 0),{value:g&&g[Q++],done:!g}}};throw TypeError(I?"Object is not iterable.":"Symbol.iterator is not defined.")}(g),I={},Q("next"),Q("throw"),Q("return"),I[Symbol.asyncIterator]=function(){return this},I);function Q(A){I[A]=g[A]&&function(I){return new Promise(function(B,Q){!function A(g,I,B,Q){Promise.resolve(Q).then(function(A){g({value:A,done:B})},I)}(B,Q,(I=g[A](I)).done,I.value)})}}}(E);!(g=(i=await o.next()).done);){Q=i.value,D=!1;try{let w=Q;w&&A.eval(w)}finally{D=!0}}}catch(G){I={error:G}}finally{try{!D&&!g&&(B=o.return)&&await B.call(o)}finally{if(I)throw I.error}}},Az=async A=>{if(A.hasAttribute("src")){let g=A.getAttribute("src"),I=await fetch(g);return I.ok?await I.text():Promise.resolve(null)}return Promise.resolve(A.innerHTML)};var Av,AX="ruby-3_2-wasm-wasi",A7="2.0.0",A_="Ruby 3.2 built on WASI",AP="./dist/index.cjs.js",A8="./dist/index.esm.js",A3="./dist/index.d.ts",A4=["dist","README.md"],A5={test:"cd ../ruby-wasm-wasi && npm test",build:"rollup -c rollup.config.mjs"},A9="https://github.com/ruby/ruby.wasm",gA="https://github.com/ruby/ruby.wasm/tree/main/packages/npm-packages/ruby-3_2-wasm-wasi",gg={access:"public"},gI=["wasm","webassembly","wasi","ruby"],gB={"@rollup/plugin-json":"^6.0.0",rollup:"^3.2.2"};AT(Object.freeze({__proto__:null,name:AX,version:A7,description:A_,main:AP,module:A8,typings:A3,files:A4,scripts:A5,repository:A9,homepage:gA,publishConfig:gg,keywords:gI,license:"MIT",devDependencies:gB,default:{name:AX,version:A7,description:A_,main:AP,"umd:main":"./dist/index.umd.js",module:A8,typings:A3,files:A4,scripts:A5,repository:A9,homepage:gA,publishConfig:gg,keywords:gI,license:"MIT",devDependencies:gB}}))}();