Opal.queue(function(Opal) {/* Generated by Opal 1.5.1 */
  var self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, $hash2 = Opal.hash2, $send = Opal.send, $eqeq = Opal.eqeq, $truthy = Opal.truthy, $gvars = Opal.gvars, b = nil, c = nil, a = nil, image = nil, text = nil;

  Opal.add_stubs('box,height,left,smooth,touch,color,length,atomes,top,rotate,alert,new,drag,shape,puts,==,circle,atome_creator,particle_creator,generate_html_renderer,[]=,style,id,is_a?,instance_exec,to_proc,append_to,DOM,atome,div,[],text=');
...
;
  ...
  image = $$('Atome').$new($hash2(["image"], {"image": $hash2(["render", "id", "type", "parent", "path", "left", "top", "width", "height"], {"render": ["html"], "id": "image_1", "type": "image", "parent": "view", "path": "./medias/images/boat.png", "left": 99, "top": 120, "width": 99, "height": 199})}));
  ...
  $send($$('Genesis'), 'generate_html_renderer', ["text"], function $$10(value, atome, proc){var self = $$10.$$s == null ? this : $$10.$$s, id_found = nil;
    ...
    self.html_object = $gvars.document['$[]'](id_found);
    return (self.html_type = "div");}, {$$arity: 3, $$s: self});
  text = $$('Atome').$new($hash2(["image"], {"image": $hash2(["render", "id", "type", "parent", "visual", "string", "left", "top", "width", "height", "color"], {"render": ["html"], "id": "text1", "type": "text", "parent": "view", "visual": $hash2(["size"], {"size": 33}), "string": "hello!", "left": 99, "top": 333, "width": 199, "height": 99, "color": $hash2(["render", "id", "type", "red", "green", "blue", "alpha"], {"render": ["html"], "id": "c315", "type": "color", "red": 1, "green": 0.15, "blue": 1, "alpha": 0.6})})}));
