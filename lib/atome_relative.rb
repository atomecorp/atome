...
if RUBY_ENGINE.downcase == 'opal'
  require_relative './renderers/browser/browser'
  require_relative './renderers/html/html'
end
require_relative './renderers/headless/headless'
require_relative './renderers/server/server'
