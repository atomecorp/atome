...
;
  ...
  $send($$('Genesis'), 'atome_creator_option', ["code_pre_render_proc"], function $$50(params){var self = $$50.$$s == null ? this : $$50.$$s, str = nil;
    ...
    $def(self, '$get_binding', function $$get_binding() {
      ...
      return Opal.Binding.$new(  function($code) {    return eval($code);  },  [],  self,  ['atome/kernel/generators/generator.rb', 429])
    }, 0);
    str = params['$[]']("value");
    self.$eval(str, self.$get_binding(), "atome/kernel/generators/generator.rb", 432);
    return params['$[]']("value");}, {$$arity: 1, $$s: self});
...
Opal.modules["atome/kernel/generators/shapes"] = function(Opal) {/* Generated by Opal 1.5.1 */
  ...
  Opal.add_stubs('[],default_params,length,atomes,instance_of?,id,merge,new,shape,box,grab,circle,text');
