...
class App < Roda
  ...
  if !File.exist?('eden_doors.sqlite3')
  ...
  index_content=index_content+ "<script>setTimeout(function(){ Opal.Object.$text('good!! Roda & puma are initialized'); }, 500);setTimeout(function(){ Opal.Object.$circle() ; }, 3000)</script>"


  index_content = index_content.gsub('<script type="text/javascript" src="../cordova.js"></script>', '')
  #below an atttempt to load atome in pure ruby not opal
