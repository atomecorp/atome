...
def vie_styles
  ...
  top_offset= 30
  {
    ...
    action_color: { red:  0.1, green: 0.1, blue: 0.1, id: :action_color },
    title: {id: :title,visual: { size: 25 }, width: :auto, left: 25,center: :horizontal,top: 20, attached: [:inactive_color]},
    # navigation_color: { red: 0.1, green:  0.1, blue: 0.1, id: :navigation_color },
    toolbox_color: { red: 0.15, green: 0.15, blue:  0.15, id: :toolbox_color },
    center_color: { red: 0.1, green: 0.1, blue:  0.1, id: :center_color },
    ...
    toolbox_style: { id: :toolbox,overflow: :hidden, left: margin, top: top_offset,smooth: smooth, width: toolbox_with, bottom: 30, height: 420, attached: [:toolbox_color] },
    inspector_style: { id: :inspector, left: toolbox_with+margin*2, top: top_offset,smooth: smooth, width: inspector_with, bottom: 0, height: 420, overflow: :auto, attached: [:inspector_color] },
    ...
    # navigation_style: { id: :navigation, left: 0, bottom: 0, top: :auto, width: :auto, right: 0, height: navigation_height, attached: [:navigation_color] },
...
# color(vie_styles[:navigation_color])
