...
# b.add(text: {data: :ok})
# # b.text(:kool)
# # b.detached([:toto, :titi])
# # b.detached(:tada)
# # # puts "-----"
# # # puts c.atome[:parents]
# # # puts "::#{b.materials}::"
# # b.circle({top: 160, id: :the_circle})
# # b.image('red_planet.png')
# # b.image('atome.svg')
# # # puts b
# # wait 1 do
# #   b.materials.each do |atome_id_found|
