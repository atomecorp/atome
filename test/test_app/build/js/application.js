Opal.queue(function(Opal) {/* Generated by Opal 1.5.1 */
  ...
  return (animation = $send($$('Atome'), 'new', [$hash2(["animation"], {"animation": $hash2(["render", "id", "type", "parent", "target", "code", "left", "top", "width", "height"], {"render": ["html"], "id": "anim1", "type": "animation", "parent": ["view"], "target": "image1", "code": "alert :poil", "left": 333, "top": 333, "width": 199, "height": 99})})], function $$7(){var self = $$7.$$s == null ? this : $$7.$$s;
